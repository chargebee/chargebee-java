...
import com.chargebee.v4.core.models.usageFile.params.UsageFileUploadUrlParams;

import com.chargebee.v4.core.responses.usageFile.UsageFileProcessingStatusResponse;

import com.chargebee.v4.core.responses.usageFile.UsageFileUploadUrlResponse;
...
public final class UsageFileService extends BaseService<UsageFileService> {
  ...
  Response processingStatusRaw(String usageFileId) throws Exception {
    String path =
        buildPathWithParams(
