...
import com.chargebee.v4.core.models.nonSubscription.params.NonSubscriptionProcessReceiptParams;

import com.chargebee.v4.core.responses.nonSubscription.NonSubscriptionProcessReceiptResponse;
...
public final class NonSubscriptionService extends BaseService<NonSubscriptionService> {
  ...
  Response processReceiptRaw(String nonSubscriptionAppId) throws Exception {
    String path =
        buildPathWithParams(
   ...
   * Response.
   */
  Response processReceiptRaw(String nonSubscriptionAppId, String jsonPayload) throws Exception {
    String path =
        buildPathWithParams(
            "/non_subscriptions/{non-subscription-app-id}/one_time_purchase",
            "non-subscription-app-id",
