...
package com.chargebee.v4.core.models.tokenConsumedEvent;

import com.chargebee.v4.internal.JsonUtil;

import com.chargebee.v4.core.models.token.Token;
...
public class TokenConsumedEvent {
  ...
  public static class Content {
    ...
    public static Content fromJson(String json) {
      ...
      String __tokenJson = JsonUtil.getObject(json, "token");
      if (__tokenJson != null) {
        obj.token = Token.fromJson(__tokenJson);
      }
