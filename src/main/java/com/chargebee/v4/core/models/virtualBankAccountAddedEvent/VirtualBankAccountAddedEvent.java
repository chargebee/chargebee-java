...
package com.chargebee.v4.core.models.virtualBankAccountAddedEvent;
...
public class VirtualBankAccountAddedEvent {
  ...
  public static VirtualBankAccountAddedEvent fromJson(String json) {
