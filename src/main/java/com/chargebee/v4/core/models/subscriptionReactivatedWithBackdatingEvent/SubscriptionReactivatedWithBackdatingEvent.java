...
package com.chargebee.v4.core.models.subscriptionReactivatedWithBackdatingEvent;
...
public class SubscriptionReactivatedWithBackdatingEvent {
  ...
  public static SubscriptionReactivatedWithBackdatingEvent fromJson(String json) {
