...
/**
 * Immutable response object for SubscriptionUpdate operation. Contains the response data from the
 * API.
 */
public final class SubscriptionUpdateResponse {
  ...
  private SubscriptionUpdateResponse(Builder builder) {
  ...
  /** Parse JSON response into SubscriptionUpdateResponse object. */
  public static SubscriptionUpdateResponse fromJson(String json) {
  ...
  public static SubscriptionUpdateResponse fromJson(String json, Response httpResponse) {
    try {
      ...
      throw new RuntimeException("Failed to parse SubscriptionUpdateResponse from JSON", e);
    }
  }

  /** Create a new builder for SubscriptionUpdateResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for SubscriptionUpdateResponse. */
  public static class Builder {
    ...
    public SubscriptionUpdateResponse build() {
