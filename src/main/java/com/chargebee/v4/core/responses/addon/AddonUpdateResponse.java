...
public final class AddonUpdateResponse extends BaseResponse {
  ...
  /** Parse JSON response into AddonUpdateResponse object with HTTP response. */
  public static AddonUpdateResponse fromJson(String json, Response httpResponse) {
    try {
