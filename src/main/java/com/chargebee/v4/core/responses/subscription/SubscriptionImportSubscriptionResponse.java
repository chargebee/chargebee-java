 ...
 * data from the API.
 */
public final class SubscriptionImportSubscriptionResponse extends BaseResponse {
  ...
  /** Parse JSON response into SubscriptionImportSubscriptionResponse object with HTTP response. */
  public static SubscriptionImportSubscriptionResponse fromJson(
