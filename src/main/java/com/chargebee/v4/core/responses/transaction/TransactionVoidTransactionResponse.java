 ...
 * from the API.
 */
public final class TransactionVoidTransactionResponse extends BaseResponse {
  ...
  /** Parse JSON response into TransactionVoidTransactionResponse object with HTTP response. */
  public static TransactionVoidTransactionResponse fromJson(String json, Response httpResponse) {
    try {
