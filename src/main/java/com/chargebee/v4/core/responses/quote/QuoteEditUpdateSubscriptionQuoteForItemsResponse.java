 ...
 */
public final class QuoteEditUpdateSubscriptionQuoteForItemsResponse extends BaseResponse {
  ...
  /**
   * Parse JSON response into QuoteEditUpdateSubscriptionQuoteForItemsResponse object with HTTP
   * response.
   */
  public static QuoteEditUpdateSubscriptionQuoteForItemsResponse fromJson(
