 ...
 */
public final class PaymentSourceCreateVoucherPaymentSourceResponse extends BaseResponse {
  ...
  /**
   * Parse JSON response into PaymentSourceCreateVoucherPaymentSourceResponse object with HTTP
   * response.
   */
  public static PaymentSourceCreateVoucherPaymentSourceResponse fromJson(
