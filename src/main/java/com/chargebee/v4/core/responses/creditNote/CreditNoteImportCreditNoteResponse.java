 ...
 * from the API.
 */
public final class CreditNoteImportCreditNoteResponse extends BaseResponse {
  ...
  /** Parse JSON response into CreditNoteImportCreditNoteResponse object with HTTP response. */
  public static CreditNoteImportCreditNoteResponse fromJson(String json, Response httpResponse) {
    try {
