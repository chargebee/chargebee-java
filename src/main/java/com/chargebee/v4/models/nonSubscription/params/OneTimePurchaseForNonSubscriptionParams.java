...
public final class OneTimePurchaseForNonSubscriptionParams {
  ...
  private OneTimePurchaseForNonSubscriptionParams(
      OneTimePurchaseForNonSubscriptionBuilder builder) {
  ...
  /** Create a new builder for OneTimePurchaseForNonSubscriptionParams. */
  @Recommended(reason = "Preferred for reusability, validation, and LLM-friendliness")
  public static OneTimePurchaseForNonSubscriptionBuilder builder() {
    return new OneTimePurchaseForNonSubscriptionBuilder();
  }

  public static final class OneTimePurchaseForNonSubscriptionBuilder {
    ...
    private OneTimePurchaseForNonSubscriptionBuilder() {}

    public OneTimePurchaseForNonSubscriptionBuilder receipt(String value) {
      this.receipt = value;
      return this;
    }

    public OneTimePurchaseForNonSubscriptionBuilder product(ProductParams value) {
      this.product = value;
      return this;
    }

    public OneTimePurchaseForNonSubscriptionBuilder customer(CustomerParams value) {
      this.customer = value;
      return this;
    }

    public OneTimePurchaseForNonSubscriptionParams build() {
      return new OneTimePurchaseForNonSubscriptionParams(this);
    }
  }
