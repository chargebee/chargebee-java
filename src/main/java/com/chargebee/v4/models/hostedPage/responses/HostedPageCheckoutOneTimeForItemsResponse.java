 ...
 * data from the API.
 */
public final class HostedPageCheckoutOneTimeForItemsResponse extends BaseResponse {
  ...
  /**
   * Parse JSON response into HostedPageCheckoutOneTimeForItemsResponse object with HTTP response.
   */
  public static HostedPageCheckoutOneTimeForItemsResponse fromJson(
  ...
  public String toString() {
    return "HostedPageCheckoutOneTimeForItemsResponse{" + "hostedPage=" + hostedPage + "}";
  }
  ...
  public boolean equals(Object o) {
    ...
    HostedPageCheckoutOneTimeForItemsResponse that = (HostedPageCheckoutOneTimeForItemsResponse) o;
