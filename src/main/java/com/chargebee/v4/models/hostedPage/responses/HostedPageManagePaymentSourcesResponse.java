 ...
 * data from the API.
 */
public final class HostedPageManagePaymentSourcesResponse extends BaseResponse {
  ...
  public String toString() {
    return "HostedPageManagePaymentSourcesResponse{" + "hostedPage=" + hostedPage + "}";
  }
  ...
  public boolean equals(Object o) {
    ...
    HostedPageManagePaymentSourcesResponse that = (HostedPageManagePaymentSourcesResponse) o;
