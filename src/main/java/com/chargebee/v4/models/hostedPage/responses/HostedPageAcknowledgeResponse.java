 ...
 * the API.
 */
public final class HostedPageAcknowledgeResponse extends BaseResponse {
  ...
  public String toString() {
    return "HostedPageAcknowledgeResponse{" + "hostedPage=" + hostedPage + "}";
  }
  ...
  public boolean equals(Object o) {
    ...
    HostedPageAcknowledgeResponse that = (HostedPageAcknowledgeResponse) o;
