...
public final class HostedPageManagePaymentSourcesParams {
  ...
  /** Create a new builder for HostedPageManagePaymentSourcesParams. */
  @Recommended(reason = "Preferred for reusability, validation, and LLM-friendliness")
  public static HostedPageManagePaymentSourcesBuilder builder() {
    return new HostedPageManagePaymentSourcesBuilder();
  }
  ...
  public static final class HostedPageManagePaymentSourcesBuilder {
    ...
    public HostedPageManagePaymentSourcesParams build() {
      return new HostedPageManagePaymentSourcesParams(this);
    }
  }
