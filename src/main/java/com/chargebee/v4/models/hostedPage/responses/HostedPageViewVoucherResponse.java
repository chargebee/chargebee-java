 ...
 * the API.
 */
public final class HostedPageViewVoucherResponse extends BaseResponse {
  ...
  /** Parse JSON response into HostedPageViewVoucherResponse object with HTTP response. */
  public static HostedPageViewVoucherResponse fromJson(String json, Response httpResponse) {
    try {
  ...
  public String toString() {
    return "HostedPageViewVoucherResponse{" + "hostedPage=" + hostedPage + "}";
  }
  ...
  public boolean equals(Object o) {
    ...
    HostedPageViewVoucherResponse that = (HostedPageViewVoucherResponse) o;
