 ...
 * the API.
 */
public final class EstimateCreateInvoiceResponse extends BaseResponse {
  ...
  /** Parse JSON response into EstimateCreateInvoiceResponse object with HTTP response. */
  public static EstimateCreateInvoiceResponse fromJson(String json, Response httpResponse) {
    try {
  ...
  public String toString() {
    return "EstimateCreateInvoiceResponse{" + "estimate=" + estimate + "}";
  }
  ...
  public boolean equals(Object o) {
    ...
    EstimateCreateInvoiceResponse that = (EstimateCreateInvoiceResponse) o;
