...
public final class EstimateGiftSubscriptionForItemsParams {
  ...
  /** Create a new builder for EstimateGiftSubscriptionForItemsParams. */
  @Recommended(reason = "Preferred for reusability, validation, and LLM-friendliness")
  public static EstimateGiftSubscriptionForItemsBuilder builder() {
    return new EstimateGiftSubscriptionForItemsBuilder();
  }

  public static final class EstimateGiftSubscriptionForItemsBuilder {
    ...
    public EstimateGiftSubscriptionForItemsBuilder couponIds(List<String> value) {
      this.couponIds = value;
      return this;
    }

    public EstimateGiftSubscriptionForItemsBuilder gift(GiftParams value) {
      this.gift = value;
      return this;
    }

    public EstimateGiftSubscriptionForItemsBuilder gifter(GifterParams value) {
      this.gifter = value;
      return this;
    }

    public EstimateGiftSubscriptionForItemsBuilder giftReceiver(GiftReceiverParams value) {
      this.giftReceiver = value;
      return this;
    }

    public EstimateGiftSubscriptionForItemsBuilder paymentIntent(PaymentIntentParams value) {
      this.paymentIntent = value;
      return this;
    }

    public EstimateGiftSubscriptionForItemsBuilder shippingAddress(ShippingAddressParams value) {
    ...
    public EstimateGiftSubscriptionForItemsParams build() {
      return new EstimateGiftSubscriptionForItemsParams(this);
    }
  }
