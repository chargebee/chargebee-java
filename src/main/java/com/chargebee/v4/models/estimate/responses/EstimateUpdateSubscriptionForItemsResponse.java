 ...
 * data from the API.
 */
public final class EstimateUpdateSubscriptionForItemsResponse extends BaseResponse {
  ...
  /**
   * Parse JSON response into EstimateUpdateSubscriptionForItemsResponse object with HTTP response.
   */
  public static EstimateUpdateSubscriptionForItemsResponse fromJson(
  ...
  public String toString() {
    return "EstimateUpdateSubscriptionForItemsResponse{" + "estimate=" + estimate + "}";
  }
