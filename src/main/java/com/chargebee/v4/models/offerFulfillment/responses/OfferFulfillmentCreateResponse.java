...
/**
 * Immutable response object for OfferFulfillmentCreate operation. Contains the response data from
 * the API.
 */
public final class OfferFulfillmentCreateResponse extends BaseResponse {
  private final OfferFulfillment offerFulfillment;

  private final HostedPage hostedPage;

  private OfferFulfillmentCreateResponse(Builder builder) {
  ...
  /** Parse JSON response into OfferFulfillmentCreateResponse object. */
  public static OfferFulfillmentCreateResponse fromJson(String json) {
    return fromJson(json, null);
  }

  /** Parse JSON response into OfferFulfillmentCreateResponse object with HTTP response. */
  public static OfferFulfillmentCreateResponse fromJson(String json, Response httpResponse) {
    try {
      ...
      throw new RuntimeException("Failed to parse OfferFulfillmentCreateResponse from JSON", e);
    }
  }

  /** Create a new builder for OfferFulfillmentCreateResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for OfferFulfillmentCreateResponse. */
  public static class Builder {
    ...
    public OfferFulfillmentCreateResponse build() {
      return new OfferFulfillmentCreateResponse(this);
    }
  }
