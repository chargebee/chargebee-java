...
public final class UnbilledChargeDeleteResponse extends BaseResponse {
  ...
  public static UnbilledChargeDeleteResponse fromJson(String json, Response httpResponse) {
    try {
      ...
      if (__unbilledChargeObj != null) {
        builder.unbilledCharge(UnbilledCharge.fromJson(__unbilledChargeObj));
      }
  ...
  public String toString() {
    return "UnbilledChargeDeleteResponse{" + "unbilledCharge=" + unbilledCharge + "}";
  }
  ...
  public boolean equals(Object o) {
    ...
    UnbilledChargeDeleteResponse that = (UnbilledChargeDeleteResponse) o;
