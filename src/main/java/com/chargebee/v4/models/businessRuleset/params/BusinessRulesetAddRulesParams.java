...
public final class BusinessRulesetAddRulesParams {

  private final List<Object> rules;

  private final Map<String, String> customFields;

  private BusinessRulesetAddRulesParams(BusinessRulesetAddRulesBuilder builder) {
  ...
  /** Create a new builder for BusinessRulesetAddRulesParams. */
  @Recommended(reason = "Preferred for reusability, validation, and LLM-friendliness")
  public static BusinessRulesetAddRulesBuilder builder() {
    return new BusinessRulesetAddRulesBuilder();
  }

  public static final class BusinessRulesetAddRulesBuilder {

    private List<Object> rules;

    private Map<String, String> customFields = new LinkedHashMap<>();

    private BusinessRulesetAddRulesBuilder() {}

    public BusinessRulesetAddRulesBuilder rules(List<Object> value) {
      this.rules = value;
      return this;
    }
     ...
     */
    public BusinessRulesetAddRulesBuilder customField(String fieldName, String value) {
     ...
     */
    public BusinessRulesetAddRulesBuilder customFields(Map<String, String> customFields) {
    ...
    public BusinessRulesetAddRulesParams build() {
      return new BusinessRulesetAddRulesParams(this);
    }
  }
}
