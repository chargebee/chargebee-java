 ...
 */
public final class SubscriptionRetrieveWithScheduledChangesResponse extends BaseResponse {
  ...
  private SubscriptionRetrieveWithScheduledChangesResponse(Builder builder) {
  ...
  /** Create a new builder for SubscriptionRetrieveWithScheduledChangesResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for SubscriptionRetrieveWithScheduledChangesResponse. */
  public static class Builder {
    ...
    public SubscriptionRetrieveWithScheduledChangesResponse build() {
      return new SubscriptionRetrieveWithScheduledChangesResponse(this);
    }
  }
