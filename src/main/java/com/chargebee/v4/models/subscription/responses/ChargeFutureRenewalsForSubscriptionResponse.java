...
/**
 * Immutable response object for ChargeFutureRenewalsForSubscription operation. Contains the
 * response data from the API.
 */
public final class ChargeFutureRenewalsForSubscriptionResponse extends BaseResponse {
  ...
  private ChargeFutureRenewalsForSubscriptionResponse(Builder builder) {
  ...
  /** Parse JSON response into ChargeFutureRenewalsForSubscriptionResponse object. */
  public static ChargeFutureRenewalsForSubscriptionResponse fromJson(String json) {
    return fromJson(json, null);
  }

  /**
   * Parse JSON response into ChargeFutureRenewalsForSubscriptionResponse object with HTTP response.
   */
  public static ChargeFutureRenewalsForSubscriptionResponse fromJson(
    ...
    try {
      ...
      throw new RuntimeException(
          "Failed to parse ChargeFutureRenewalsForSubscriptionResponse from JSON", e);
    }
  }

  /** Create a new builder for ChargeFutureRenewalsForSubscriptionResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for ChargeFutureRenewalsForSubscriptionResponse. */
  public static class Builder {
    ...
    public ChargeFutureRenewalsForSubscriptionResponse build() {
      return new ChargeFutureRenewalsForSubscriptionResponse(this);
    }
  }
