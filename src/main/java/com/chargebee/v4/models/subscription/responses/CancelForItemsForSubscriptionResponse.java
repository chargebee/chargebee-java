...
/**
 * Immutable response object for CancelForItemsForSubscription operation. Contains the response data
 * from the API.
 */
public final class CancelForItemsForSubscriptionResponse extends BaseResponse {
  ...
  private CancelForItemsForSubscriptionResponse(Builder builder) {
  ...
  /** Parse JSON response into CancelForItemsForSubscriptionResponse object. */
  public static CancelForItemsForSubscriptionResponse fromJson(String json) {
    return fromJson(json, null);
  }

  /** Parse JSON response into CancelForItemsForSubscriptionResponse object with HTTP response. */
  public static CancelForItemsForSubscriptionResponse fromJson(String json, Response httpResponse) {
    try {
      ...
      throw new RuntimeException(
          "Failed to parse CancelForItemsForSubscriptionResponse from JSON", e);
    }
  }

  /** Create a new builder for CancelForItemsForSubscriptionResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for CancelForItemsForSubscriptionResponse. */
  public static class Builder {
    ...
    public CancelForItemsForSubscriptionResponse build() {
      return new CancelForItemsForSubscriptionResponse(this);
    }
  }
