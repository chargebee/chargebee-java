...
/**
 * Immutable response object for UpdateForItemsForSubscription operation. Contains the response data
 * from the API.
 */
public final class UpdateForItemsForSubscriptionResponse extends BaseResponse {
  ...
  private UpdateForItemsForSubscriptionResponse(Builder builder) {
  ...
  /** Parse JSON response into UpdateForItemsForSubscriptionResponse object. */
  public static UpdateForItemsForSubscriptionResponse fromJson(String json) {
    return fromJson(json, null);
  }

  /** Parse JSON response into UpdateForItemsForSubscriptionResponse object with HTTP response. */
  public static UpdateForItemsForSubscriptionResponse fromJson(String json, Response httpResponse) {
    try {
      ...
      throw new RuntimeException(
          "Failed to parse UpdateForItemsForSubscriptionResponse from JSON", e);
    }
  }

  /** Create a new builder for UpdateForItemsForSubscriptionResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for UpdateForItemsForSubscriptionResponse. */
  public static class Builder {
    ...
    public UpdateForItemsForSubscriptionResponse build() {
      return new UpdateForItemsForSubscriptionResponse(this);
    }
  }
