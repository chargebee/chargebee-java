...
/**
 * Immutable response object for ChangeTermEndForSubscription operation. Contains the response data
 * from the API.
 */
public final class ChangeTermEndForSubscriptionResponse extends BaseResponse {
  ...
  private ChangeTermEndForSubscriptionResponse(Builder builder) {
  ...
  /** Parse JSON response into ChangeTermEndForSubscriptionResponse object. */
  public static ChangeTermEndForSubscriptionResponse fromJson(String json) {
    return fromJson(json, null);
  }

  /** Parse JSON response into ChangeTermEndForSubscriptionResponse object with HTTP response. */
  public static ChangeTermEndForSubscriptionResponse fromJson(String json, Response httpResponse) {
    try {
      ...
      throw new RuntimeException(
          "Failed to parse ChangeTermEndForSubscriptionResponse from JSON", e);
    }
  }

  /** Create a new builder for ChangeTermEndForSubscriptionResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for ChangeTermEndForSubscriptionResponse. */
  public static class Builder {
    ...
    public ChangeTermEndForSubscriptionResponse build() {
      return new ChangeTermEndForSubscriptionResponse(this);
    }
  }
