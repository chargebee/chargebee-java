...
/**
 * Immutable response object for CancelForSubscription operation. Contains the response data from
 * the API.
 */
public final class CancelForSubscriptionResponse extends BaseResponse {
  ...
  private CancelForSubscriptionResponse(Builder builder) {
  ...
  /** Parse JSON response into CancelForSubscriptionResponse object. */
  public static CancelForSubscriptionResponse fromJson(String json) {
    return fromJson(json, null);
  }

  /** Parse JSON response into CancelForSubscriptionResponse object with HTTP response. */
  public static CancelForSubscriptionResponse fromJson(String json, Response httpResponse) {
    try {
      ...
      throw new RuntimeException("Failed to parse CancelForSubscriptionResponse from JSON", e);
    }
  }

  /** Create a new builder for CancelForSubscriptionResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for CancelForSubscriptionResponse. */
  public static class Builder {
    ...
    public CancelForSubscriptionResponse build() {
      return new CancelForSubscriptionResponse(this);
    }
  }
