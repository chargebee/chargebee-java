...
/**
 * Immutable response object for ReactivateForSubscription operation. Contains the response data
 * from the API.
 */
public final class ReactivateForSubscriptionResponse extends BaseResponse {
  ...
  private ReactivateForSubscriptionResponse(Builder builder) {
  ...
  /** Parse JSON response into ReactivateForSubscriptionResponse object. */
  public static ReactivateForSubscriptionResponse fromJson(String json) {
    return fromJson(json, null);
  }

  /** Parse JSON response into ReactivateForSubscriptionResponse object with HTTP response. */
  public static ReactivateForSubscriptionResponse fromJson(String json, Response httpResponse) {
    try {
      ...
      throw new RuntimeException("Failed to parse ReactivateForSubscriptionResponse from JSON", e);
    }
  }

  /** Create a new builder for ReactivateForSubscriptionResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for ReactivateForSubscriptionResponse. */
  public static class Builder {
    ...
    public ReactivateForSubscriptionResponse build() {
      return new ReactivateForSubscriptionResponse(this);
    }
  }
