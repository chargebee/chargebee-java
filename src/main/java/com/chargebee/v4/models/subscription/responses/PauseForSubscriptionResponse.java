...
/**
 * Immutable response object for PauseForSubscription operation. Contains the response data from the
 * API.
 */
public final class PauseForSubscriptionResponse extends BaseResponse {
  ...
  private PauseForSubscriptionResponse(Builder builder) {
  ...
  /** Parse JSON response into PauseForSubscriptionResponse object. */
  public static PauseForSubscriptionResponse fromJson(String json) {
    return fromJson(json, null);
  }

  /** Parse JSON response into PauseForSubscriptionResponse object with HTTP response. */
  public static PauseForSubscriptionResponse fromJson(String json, Response httpResponse) {
    try {
      ...
      throw new RuntimeException("Failed to parse PauseForSubscriptionResponse from JSON", e);
    }
  }

  /** Create a new builder for PauseForSubscriptionResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for PauseForSubscriptionResponse. */
  public static class Builder {
    ...
    public PauseForSubscriptionResponse build() {
      return new PauseForSubscriptionResponse(this);
    }
  }
