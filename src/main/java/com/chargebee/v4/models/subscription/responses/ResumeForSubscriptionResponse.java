...
/**
 * Immutable response object for ResumeForSubscription operation. Contains the response data from
 * the API.
 */
public final class ResumeForSubscriptionResponse extends BaseResponse {
  ...
  private ResumeForSubscriptionResponse(Builder builder) {
  ...
  /** Parse JSON response into ResumeForSubscriptionResponse object. */
  public static ResumeForSubscriptionResponse fromJson(String json) {
    return fromJson(json, null);
  }

  /** Parse JSON response into ResumeForSubscriptionResponse object with HTTP response. */
  public static ResumeForSubscriptionResponse fromJson(String json, Response httpResponse) {
    try {
      ...
      throw new RuntimeException("Failed to parse ResumeForSubscriptionResponse from JSON", e);
    }
  }

  /** Create a new builder for ResumeForSubscriptionResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for ResumeForSubscriptionResponse. */
  public static class Builder {
    ...
    public ResumeForSubscriptionResponse build() {
      return new ResumeForSubscriptionResponse(this);
    }
  }
