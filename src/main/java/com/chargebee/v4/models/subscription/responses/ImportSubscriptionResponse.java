...
/**
 * Immutable response object for ImportSubscription operation. Contains the response data from the
 * API.
 */
public final class ImportSubscriptionResponse extends BaseResponse {
  ...
  private ImportSubscriptionResponse(Builder builder) {
  ...
  /** Parse JSON response into ImportSubscriptionResponse object. */
  public static ImportSubscriptionResponse fromJson(String json) {
    return fromJson(json, null);
  }

  /** Parse JSON response into ImportSubscriptionResponse object with HTTP response. */
  public static ImportSubscriptionResponse fromJson(String json, Response httpResponse) {
    try {
      ...
      throw new RuntimeException("Failed to parse ImportSubscriptionResponse from JSON", e);
    }
  }

  /** Create a new builder for ImportSubscriptionResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for ImportSubscriptionResponse. */
  public static class Builder {
    ...
    public ImportSubscriptionResponse build() {
      return new ImportSubscriptionResponse(this);
    }
  }
