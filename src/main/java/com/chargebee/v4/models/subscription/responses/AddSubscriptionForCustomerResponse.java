...
/**
 * Immutable response object for AddSubscriptionForCustomer operation. Contains the response data
 * from the API.
 */
public final class AddSubscriptionForCustomerResponse extends BaseResponse {
  ...
  private AddSubscriptionForCustomerResponse(Builder builder) {
  ...
  /** Parse JSON response into AddSubscriptionForCustomerResponse object. */
  public static AddSubscriptionForCustomerResponse fromJson(String json) {
    return fromJson(json, null);
  }

  /** Parse JSON response into AddSubscriptionForCustomerResponse object with HTTP response. */
  public static AddSubscriptionForCustomerResponse fromJson(String json, Response httpResponse) {
    try {
      ...
      throw new RuntimeException("Failed to parse AddSubscriptionForCustomerResponse from JSON", e);
    }
  }

  /** Create a new builder for AddSubscriptionForCustomerResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for AddSubscriptionForCustomerResponse. */
  public static class Builder {
    ...
    public AddSubscriptionForCustomerResponse build() {
      return new AddSubscriptionForCustomerResponse(this);
    }
  }
