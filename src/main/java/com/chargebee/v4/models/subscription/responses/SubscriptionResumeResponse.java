...
/**
 * Immutable response object for SubscriptionResume operation. Contains the response data from the
 * API.
 */
public final class SubscriptionResumeResponse extends BaseResponse {
  ...
  private SubscriptionResumeResponse(Builder builder) {
  ...
  /** Parse JSON response into SubscriptionResumeResponse object. */
  public static SubscriptionResumeResponse fromJson(String json) {
    return fromJson(json, null);
  }

  /** Parse JSON response into SubscriptionResumeResponse object with HTTP response. */
  public static SubscriptionResumeResponse fromJson(String json, Response httpResponse) {
    try {
      ...
      throw new RuntimeException("Failed to parse SubscriptionResumeResponse from JSON", e);
    }
  }

  /** Create a new builder for SubscriptionResumeResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for SubscriptionResumeResponse. */
  public static class Builder {
    ...
    public SubscriptionResumeResponse build() {
      return new SubscriptionResumeResponse(this);
    }
  }
  ...
  public boolean equals(Object o) {
    ...
    SubscriptionResumeResponse that = (SubscriptionResumeResponse) o;
