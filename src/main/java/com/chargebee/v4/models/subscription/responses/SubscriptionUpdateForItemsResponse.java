...
/**
 * Immutable response object for SubscriptionUpdateForItems operation. Contains the response data
 * from the API.
 */
public final class SubscriptionUpdateForItemsResponse extends BaseResponse {
  ...
  private SubscriptionUpdateForItemsResponse(Builder builder) {
  ...
  /** Parse JSON response into SubscriptionUpdateForItemsResponse object. */
  public static SubscriptionUpdateForItemsResponse fromJson(String json) {
    return fromJson(json, null);
  }

  /** Parse JSON response into SubscriptionUpdateForItemsResponse object with HTTP response. */
  public static SubscriptionUpdateForItemsResponse fromJson(String json, Response httpResponse) {
    try {
      ...
      throw new RuntimeException("Failed to parse SubscriptionUpdateForItemsResponse from JSON", e);
    }
  }

  /** Create a new builder for SubscriptionUpdateForItemsResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for SubscriptionUpdateForItemsResponse. */
  public static class Builder {
    ...
    public SubscriptionUpdateForItemsResponse build() {
      return new SubscriptionUpdateForItemsResponse(this);
    }
  }
  ...
  public String toString() {
    return "SubscriptionUpdateForItemsResponse{"
        + "subscription="
        + subscription
        + ", customer="
        + customer
  ...
  public boolean equals(Object o) {
    ...
    SubscriptionUpdateForItemsResponse that = (SubscriptionUpdateForItemsResponse) o;
