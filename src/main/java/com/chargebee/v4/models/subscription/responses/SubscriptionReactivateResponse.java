 ...
 * the API.
 */
public final class SubscriptionReactivateResponse extends BaseResponse {
  ...
  /** Parse JSON response into SubscriptionReactivateResponse object with HTTP response. */
  public static SubscriptionReactivateResponse fromJson(String json, Response httpResponse) {
    try {
  ...
  public boolean equals(Object o) {
    ...
    SubscriptionReactivateResponse that = (SubscriptionReactivateResponse) o;
