 ...
 * from the API.
 */
public final class SubscriptionImportForCustomerResponse extends BaseResponse {
  ...
  /** Parse JSON response into SubscriptionImportForCustomerResponse object with HTTP response. */
  public static SubscriptionImportForCustomerResponse fromJson(String json, Response httpResponse) {
    try {
  ...
  public String toString() {
    return "SubscriptionImportForCustomerResponse{"
        + "subscription="
        + subscription
        + ", customer="
        + customer
  ...
  public boolean equals(Object o) {
    ...
    SubscriptionImportForCustomerResponse that = (SubscriptionImportForCustomerResponse) o;
