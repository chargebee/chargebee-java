...
/**
 * Immutable response object for SubscriptionCancel operation. Contains the response data from the
 * API.
 */
public final class SubscriptionCancelResponse extends BaseResponse {
  ...
  private SubscriptionCancelResponse(Builder builder) {
  ...
  /** Parse JSON response into SubscriptionCancelResponse object. */
  public static SubscriptionCancelResponse fromJson(String json) {
    return fromJson(json, null);
  }

  /** Parse JSON response into SubscriptionCancelResponse object with HTTP response. */
  public static SubscriptionCancelResponse fromJson(String json, Response httpResponse) {
    try {
      ...
      throw new RuntimeException("Failed to parse SubscriptionCancelResponse from JSON", e);
    }
  }

  /** Create a new builder for SubscriptionCancelResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for SubscriptionCancelResponse. */
  public static class Builder {
    ...
    public SubscriptionCancelResponse build() {
      return new SubscriptionCancelResponse(this);
    }
  }
