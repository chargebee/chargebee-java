...
/**
 * Immutable response object for SubscriptionCreateWithItems operation. Contains the response data
 * from the API.
 */
public final class SubscriptionCreateWithItemsResponse extends BaseResponse {
  ...
  private SubscriptionCreateWithItemsResponse(Builder builder) {
  ...
  /** Parse JSON response into SubscriptionCreateWithItemsResponse object. */
  public static SubscriptionCreateWithItemsResponse fromJson(String json) {
    return fromJson(json, null);
  }

  /** Parse JSON response into SubscriptionCreateWithItemsResponse object with HTTP response. */
  public static SubscriptionCreateWithItemsResponse fromJson(String json, Response httpResponse) {
    try {
      ...
      throw new RuntimeException(
          "Failed to parse SubscriptionCreateWithItemsResponse from JSON", e);
    }
  }

  /** Create a new builder for SubscriptionCreateWithItemsResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for SubscriptionCreateWithItemsResponse. */
  public static class Builder {
    ...
    public SubscriptionCreateWithItemsResponse build() {
      return new SubscriptionCreateWithItemsResponse(this);
    }
  }
  ...
  public String toString() {
    return "SubscriptionCreateWithItemsResponse{"
        + "subscription="
        + subscription
        + ", customer="
        + customer
