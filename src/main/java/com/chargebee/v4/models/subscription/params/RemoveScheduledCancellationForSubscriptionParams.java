...
public final class RemoveScheduledCancellationForSubscriptionParams {
  ...
  private RemoveScheduledCancellationForSubscriptionParams(
      RemoveScheduledCancellationForSubscriptionBuilder builder) {
  ...
  /** Create a new builder for RemoveScheduledCancellationForSubscriptionParams. */
  @Recommended(reason = "Preferred for reusability, validation, and LLM-friendliness")
  public static RemoveScheduledCancellationForSubscriptionBuilder builder() {
    return new RemoveScheduledCancellationForSubscriptionBuilder();
  }

  public static final class RemoveScheduledCancellationForSubscriptionBuilder {
    ...
    private RemoveScheduledCancellationForSubscriptionBuilder() {}

    public RemoveScheduledCancellationForSubscriptionBuilder billingCycles(Integer value) {
      this.billingCycles = value;
      return this;
    }

    public RemoveScheduledCancellationForSubscriptionBuilder contractTermBillingCycleOnRenewal(
        Integer value) {
      this.contractTermBillingCycleOnRenewal = value;
      return this;
    }

    public RemoveScheduledCancellationForSubscriptionBuilder contractTerm(
        ContractTermParams value) {
      this.contractTerm = value;
      return this;
    }

    public RemoveScheduledCancellationForSubscriptionParams build() {
      return new RemoveScheduledCancellationForSubscriptionParams(this);
    }
  }
