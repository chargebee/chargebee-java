...
/**
 * Immutable response object for UpdateStatusForQuote operation. Contains the response data from the
 * API.
 */
public final class UpdateStatusForQuoteResponse extends BaseResponse {
  ...
  private UpdateStatusForQuoteResponse(Builder builder) {
  ...
  /** Parse JSON response into UpdateStatusForQuoteResponse object. */
  public static UpdateStatusForQuoteResponse fromJson(String json) {
    return fromJson(json, null);
  }

  /** Parse JSON response into UpdateStatusForQuoteResponse object with HTTP response. */
  public static UpdateStatusForQuoteResponse fromJson(String json, Response httpResponse) {
    try {
      ...
      throw new RuntimeException("Failed to parse UpdateStatusForQuoteResponse from JSON", e);
    }
  }

  /** Create a new builder for UpdateStatusForQuoteResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for UpdateStatusForQuoteResponse. */
  public static class Builder {
    ...
    public UpdateStatusForQuoteResponse build() {
      return new UpdateStatusForQuoteResponse(this);
    }
  }
