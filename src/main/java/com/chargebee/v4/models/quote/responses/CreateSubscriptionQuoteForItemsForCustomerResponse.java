...
/**
 * Immutable response object for CreateSubscriptionQuoteForItemsForCustomer operation. Contains the
 * response data from the API.
 */
public final class CreateSubscriptionQuoteForItemsForCustomerResponse extends BaseResponse {
  ...
  private CreateSubscriptionQuoteForItemsForCustomerResponse(Builder builder) {
  ...
  /** Parse JSON response into CreateSubscriptionQuoteForItemsForCustomerResponse object. */
  public static CreateSubscriptionQuoteForItemsForCustomerResponse fromJson(String json) {
    return fromJson(json, null);
  }

  /**
   * Parse JSON response into CreateSubscriptionQuoteForItemsForCustomerResponse object with HTTP
   * response.
   */
  public static CreateSubscriptionQuoteForItemsForCustomerResponse fromJson(
    ...
    try {
      ...
      throw new RuntimeException(
          "Failed to parse CreateSubscriptionQuoteForItemsForCustomerResponse from JSON", e);
    }
  }

  /** Create a new builder for CreateSubscriptionQuoteForItemsForCustomerResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for CreateSubscriptionQuoteForItemsForCustomerResponse. */
  public static class Builder {
    ...
    public CreateSubscriptionQuoteForItemsForCustomerResponse build() {
      return new CreateSubscriptionQuoteForItemsForCustomerResponse(this);
    }
  }
