...
public final class QuotePdfParams {
  ...
  /** Create a new builder for QuotePdfParams. */
  @Recommended(reason = "Preferred for reusability, validation, and LLM-friendliness")
  public static QuotePdfBuilder builder() {
    return new QuotePdfBuilder();
  }

  public static final class QuotePdfBuilder {
