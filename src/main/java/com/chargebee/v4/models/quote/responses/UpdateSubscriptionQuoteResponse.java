...
/**
 * Immutable response object for UpdateSubscriptionQuote operation. Contains the response data from
 * the API.
 */
public final class UpdateSubscriptionQuoteResponse extends BaseResponse {
  private final Quote quote;

  private final QuotedSubscription quotedSubscription;

  private UpdateSubscriptionQuoteResponse(Builder builder) {
  ...
  /** Parse JSON response into UpdateSubscriptionQuoteResponse object. */
  public static UpdateSubscriptionQuoteResponse fromJson(String json) {
    return fromJson(json, null);
  }

  /** Parse JSON response into UpdateSubscriptionQuoteResponse object with HTTP response. */
  public static UpdateSubscriptionQuoteResponse fromJson(String json, Response httpResponse) {
    try {
      ...
      throw new RuntimeException("Failed to parse UpdateSubscriptionQuoteResponse from JSON", e);
    }
  }

  /** Create a new builder for UpdateSubscriptionQuoteResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for UpdateSubscriptionQuoteResponse. */
  public static class Builder {
    ...
    public UpdateSubscriptionQuoteResponse build() {
      return new UpdateSubscriptionQuoteResponse(this);
    }
  }
