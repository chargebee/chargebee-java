...
public final class QuoteUpdateStatusResponse extends BaseResponse {
  ...
  /** Create a new builder for QuoteUpdateStatusResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for QuoteUpdateStatusResponse. */
  public static class Builder {
    ...
    public QuoteUpdateStatusResponse build() {
      return new QuoteUpdateStatusResponse(this);
    }
  }
  ...
  public String toString() {
    return "QuoteUpdateStatusResponse{"
        + "quote="
        + quote
        + ", quotedSubscription="
        + quotedSubscription
  ...
  public boolean equals(Object o) {
    ...
    QuoteUpdateStatusResponse that = (QuoteUpdateStatusResponse) o;
