...
/**
 * Immutable response object for EditCreateSubscriptionQuoteForItemsForQuote operation. Contains the
 * response data from the API.
 */
public final class EditCreateSubscriptionQuoteForItemsForQuoteResponse extends BaseResponse {
  ...
  private EditCreateSubscriptionQuoteForItemsForQuoteResponse(Builder builder) {
  ...
  /** Parse JSON response into EditCreateSubscriptionQuoteForItemsForQuoteResponse object. */
  public static EditCreateSubscriptionQuoteForItemsForQuoteResponse fromJson(String json) {
    return fromJson(json, null);
  }

  /**
   * Parse JSON response into EditCreateSubscriptionQuoteForItemsForQuoteResponse object with HTTP
   * response.
   */
  public static EditCreateSubscriptionQuoteForItemsForQuoteResponse fromJson(
    ...
    try {
      ...
      throw new RuntimeException(
          "Failed to parse EditCreateSubscriptionQuoteForItemsForQuoteResponse from JSON", e);
    }
  }

  /** Create a new builder for EditCreateSubscriptionQuoteForItemsForQuoteResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for EditCreateSubscriptionQuoteForItemsForQuoteResponse. */
  public static class Builder {
    ...
    public EditCreateSubscriptionQuoteForItemsForQuoteResponse build() {
      return new EditCreateSubscriptionQuoteForItemsForQuoteResponse(this);
    }
  }
