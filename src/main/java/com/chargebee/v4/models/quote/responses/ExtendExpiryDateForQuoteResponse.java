...
/**
 * Immutable response object for ExtendExpiryDateForQuote operation. Contains the response data from
 * the API.
 */
public final class ExtendExpiryDateForQuoteResponse extends BaseResponse {
  ...
  private ExtendExpiryDateForQuoteResponse(Builder builder) {
  ...
  /** Parse JSON response into ExtendExpiryDateForQuoteResponse object. */
  public static ExtendExpiryDateForQuoteResponse fromJson(String json) {
    return fromJson(json, null);
  }

  /** Parse JSON response into ExtendExpiryDateForQuoteResponse object with HTTP response. */
  public static ExtendExpiryDateForQuoteResponse fromJson(String json, Response httpResponse) {
    try {
      ...
      throw new RuntimeException("Failed to parse ExtendExpiryDateForQuoteResponse from JSON", e);
    }
  }

  /** Create a new builder for ExtendExpiryDateForQuoteResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for ExtendExpiryDateForQuoteResponse. */
  public static class Builder {
    ...
    public ExtendExpiryDateForQuoteResponse build() {
      return new ExtendExpiryDateForQuoteResponse(this);
    }
  }
