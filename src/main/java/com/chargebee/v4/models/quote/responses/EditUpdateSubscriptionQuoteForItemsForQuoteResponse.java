...
/**
 * Immutable response object for EditUpdateSubscriptionQuoteForItemsForQuote operation. Contains the
 * response data from the API.
 */
public final class EditUpdateSubscriptionQuoteForItemsForQuoteResponse extends BaseResponse {
  ...
  private EditUpdateSubscriptionQuoteForItemsForQuoteResponse(Builder builder) {
  ...
  /** Parse JSON response into EditUpdateSubscriptionQuoteForItemsForQuoteResponse object. */
  public static EditUpdateSubscriptionQuoteForItemsForQuoteResponse fromJson(String json) {
    return fromJson(json, null);
  }

  /**
   * Parse JSON response into EditUpdateSubscriptionQuoteForItemsForQuoteResponse object with HTTP
   * response.
   */
  public static EditUpdateSubscriptionQuoteForItemsForQuoteResponse fromJson(
    ...
    try {
      ...
      throw new RuntimeException(
          "Failed to parse EditUpdateSubscriptionQuoteForItemsForQuoteResponse from JSON", e);
    }
  }

  /** Create a new builder for EditUpdateSubscriptionQuoteForItemsForQuoteResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for EditUpdateSubscriptionQuoteForItemsForQuoteResponse. */
  public static class Builder {
    ...
    public EditUpdateSubscriptionQuoteForItemsForQuoteResponse build() {
      return new EditUpdateSubscriptionQuoteForItemsForQuoteResponse(this);
    }
  }
