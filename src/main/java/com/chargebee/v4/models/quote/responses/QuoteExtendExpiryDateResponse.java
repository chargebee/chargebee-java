 ...
 * the API.
 */
public final class QuoteExtendExpiryDateResponse extends BaseResponse {
  ...
  /** Parse JSON response into QuoteExtendExpiryDateResponse object with HTTP response. */
  public static QuoteExtendExpiryDateResponse fromJson(String json, Response httpResponse) {
    try {
  ...
  public String toString() {
    return "QuoteExtendExpiryDateResponse{"
        + "quote="
        + quote
        + ", quotedSubscription="
        + quotedSubscription
  ...
  public boolean equals(Object o) {
    ...
    QuoteExtendExpiryDateResponse that = (QuoteExtendExpiryDateResponse) o;
