...
public class Quote {
  ...
  public static Quote fromJson(JsonObject jsonObj) {
    ...
    obj.operationType = OperationType.fromString(JsonUtil.getString(jsonObj, "operation_type"));
    ...
    obj.totalPayable = JsonUtil.getLong(jsonObj, "total_payable");

    obj.chargeOnAcceptance = JsonUtil.getLong(jsonObj, "charge_on_acceptance");
    ...
    obj.contractTermEnd = JsonUtil.getTimestamp(jsonObj, "contract_term_end");

    obj.contractTermTerminationFee = JsonUtil.getLong(jsonObj, "contract_term_termination_fee");
