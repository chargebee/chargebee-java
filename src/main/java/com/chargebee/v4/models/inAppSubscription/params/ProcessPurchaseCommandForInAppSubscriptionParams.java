...
public final class ProcessPurchaseCommandForInAppSubscriptionParams {
  ...
  private ProcessPurchaseCommandForInAppSubscriptionParams(
      ProcessPurchaseCommandForInAppSubscriptionBuilder builder) {
  ...
  /** Create a new builder for ProcessPurchaseCommandForInAppSubscriptionParams. */
  @Recommended(reason = "Preferred for reusability, validation, and LLM-friendliness")
  public static ProcessPurchaseCommandForInAppSubscriptionBuilder builder() {
    return new ProcessPurchaseCommandForInAppSubscriptionBuilder();
  }

  public static final class ProcessPurchaseCommandForInAppSubscriptionBuilder {
    ...
    private ProcessPurchaseCommandForInAppSubscriptionBuilder() {}

    public ProcessPurchaseCommandForInAppSubscriptionBuilder receipt(String value) {
      this.receipt = value;
      return this;
    }

    public ProcessPurchaseCommandForInAppSubscriptionBuilder product(ProductParams value) {
      this.product = value;
      return this;
    }

    public ProcessPurchaseCommandForInAppSubscriptionBuilder customer(CustomerParams value) {
      this.customer = value;
      return this;
    }

    public ProcessPurchaseCommandForInAppSubscriptionParams build() {
      return new ProcessPurchaseCommandForInAppSubscriptionParams(this);
    }
  }
