...
public final class DeleteItemParams {

  private DeleteItemParams(DeleteItemBuilder builder) {}
  ...
  /** Create a new builder for DeleteItemParams. */
  ...
  public static final class DeleteItemBuilder {

    private DeleteItemBuilder() {}

    public DeleteItemParams build() {
      return new DeleteItemParams(this);
    }
  }
}
