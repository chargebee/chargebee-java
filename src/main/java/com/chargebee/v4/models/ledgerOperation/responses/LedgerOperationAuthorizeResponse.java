...
/**
 * Immutable response object for LedgerOperationAuthorize operation. Contains the response data from
 * the API.
 */
public final class LedgerOperationAuthorizeResponse extends BaseResponse {
  ...
  private LedgerOperationAuthorizeResponse(Builder builder) {
  ...
  /** Parse JSON response into LedgerOperationAuthorizeResponse object. */
  public static LedgerOperationAuthorizeResponse fromJson(String json) {
    return fromJson(json, null);
  }

  /** Parse JSON response into LedgerOperationAuthorizeResponse object with HTTP response. */
  public static LedgerOperationAuthorizeResponse fromJson(String json, Response httpResponse) {
    try {
      ...
      throw new RuntimeException("Failed to parse LedgerOperationAuthorizeResponse from JSON", e);
    }
  }

  /** Create a new builder for LedgerOperationAuthorizeResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for LedgerOperationAuthorizeResponse. */
  public static class Builder {
    ...
    public LedgerOperationAuthorizeResponse build() {
      return new LedgerOperationAuthorizeResponse(this);
    }
  }
  ...
  public boolean equals(Object o) {
    ...
    LedgerOperationAuthorizeResponse that = (LedgerOperationAuthorizeResponse) o;
