...
public final class LedgerOperationCaptureParams {
  ...
  private LedgerOperationCaptureParams(LedgerOperationCaptureBuilder builder) {
  ...
  public static LedgerOperationCaptureBuilder builder() {
    return new LedgerOperationCaptureBuilder();
  }

  public static final class LedgerOperationCaptureBuilder {
    ...
    private LedgerOperationCaptureBuilder() {}

    public LedgerOperationCaptureBuilder id(String value) {
      this.id = value;
      return this;
    }

    public LedgerOperationCaptureBuilder subscriptionId(String value) {
      this.subscriptionId = value;
      return this;
    }

    public LedgerOperationCaptureBuilder unitId(String value) {
      this.unitId = value;
      return this;
    }

    public LedgerOperationCaptureBuilder amount(String value) {
      this.amount = value;
      return this;
    }

    public LedgerOperationCaptureBuilder ledgerOperationTimestamp(Timestamp value) {
      this.ledgerOperationTimestamp = value;
      return this;
    }

    public LedgerOperationCaptureBuilder metadata(java.util.Map<String, Object> value) {
      this.metadata = value;
      return this;
    }

    public LedgerOperationCaptureParams build() {
      return new LedgerOperationCaptureParams(this);
    }
  }
}
