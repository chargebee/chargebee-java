...
public final class PlanCreateParams {
  ...
  public Map<String, Object> toFormData() {
    ...
    if (this.giftable != null) {
      ...
      formData.put("giftable", this.giftable);
    }
    ...
    if (this.claimUrl != null) {
      ...
      formData.put("claim_url", this.claimUrl);
    }
  ...
  public static final class PlanCreateBuilder {
    ...
    @Deprecated
    public PlanCreateBuilder downgradePenalty(Double value) {
     ...
     */
    public PlanCreateBuilder customField(String fieldName, String value) {
     ...
     */
    public PlanCreateBuilder customFields(Map<String, String> customFields) {
