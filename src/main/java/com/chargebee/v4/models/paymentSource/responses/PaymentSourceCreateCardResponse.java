 ...
 * the API.
 */
public final class PaymentSourceCreateCardResponse extends BaseResponse {
  ...
  /** Parse JSON response into PaymentSourceCreateCardResponse object with HTTP response. */
  public static PaymentSourceCreateCardResponse fromJson(String json, Response httpResponse) {
    try {
