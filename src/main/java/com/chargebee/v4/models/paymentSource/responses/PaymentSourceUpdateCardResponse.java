 ...
 * the API.
 */
public final class PaymentSourceUpdateCardResponse extends BaseResponse {
  ...
  public String toString() {
    return "PaymentSourceUpdateCardResponse{"
        + "customer="
        + customer
        + ", paymentSource="
        + paymentSource
  ...
  public boolean equals(Object o) {
    ...
    PaymentSourceUpdateCardResponse that = (PaymentSourceUpdateCardResponse) o;
