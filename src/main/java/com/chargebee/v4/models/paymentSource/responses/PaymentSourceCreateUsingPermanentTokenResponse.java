 ...
 */
public final class PaymentSourceCreateUsingPermanentTokenResponse extends BaseResponse {
  ...
  /**
   * Parse JSON response into PaymentSourceCreateUsingPermanentTokenResponse object with HTTP
   * response.
   */
  public static PaymentSourceCreateUsingPermanentTokenResponse fromJson(
  ...
  public String toString() {
    return "PaymentSourceCreateUsingPermanentTokenResponse{"
        + "customer="
        + customer
        + ", paymentSource="
        + paymentSource
