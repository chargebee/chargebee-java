 ...
 * data from the API.
 */
public final class PaymentSourceUpdateBankAccountResponse extends BaseResponse {
  ...
  /** Parse JSON response into PaymentSourceUpdateBankAccountResponse object with HTTP response. */
  public static PaymentSourceUpdateBankAccountResponse fromJson(
  ...
  public String toString() {
    return "PaymentSourceUpdateBankAccountResponse{"
        + "customer="
        + customer
        + ", paymentSource="
        + paymentSource
  ...
  public boolean equals(Object o) {
    ...
    PaymentSourceUpdateBankAccountResponse that = (PaymentSourceUpdateBankAccountResponse) o;
