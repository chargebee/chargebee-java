 ...
 * from the API.
 */
public final class PaymentSourceAgreementPdfResponse extends BaseResponse {
  ...
  /** Parse JSON response into PaymentSourceAgreementPdfResponse object with HTTP response. */
  public static PaymentSourceAgreementPdfResponse fromJson(String json, Response httpResponse) {
    try {
  ...
  public String toString() {
    return "PaymentSourceAgreementPdfResponse{" + "download=" + download + "}";
  }
