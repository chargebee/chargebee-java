...
package com.chargebee.v4.models.meter.params;
...
public final class MeterListParams {

  private final Map<String, Object> queryParams;

  private MeterListParams(MeterListBuilder builder) {
  ...
  public MeterListBuilder toBuilder() {
    MeterListBuilder builder = new MeterListBuilder();
    builder.queryParams.putAll(queryParams);
    return builder;
  }

  /** Create a new builder for MeterListParams. */
  @Recommended(reason = "Preferred for reusability, validation, and LLM-friendliness")
  public static MeterListBuilder builder() {
    return new MeterListBuilder();
  }

  public static final class MeterListBuilder {
    private final Map<String, Object> queryParams = new LinkedHashMap<>();

    private MeterListBuilder() {}

    public MeterListBuilder limit(Integer value) {
      queryParams.put("limit", value);
      return this;
    }

    public MeterListBuilder offset(String value) {
    ...
    public MeterListParams build() {
      return new MeterListParams(this);
    }

    public static final class NameFilter extends StringFilter<MeterListBuilder> {
      NameFilter(String fieldName, MeterListBuilder builder, Map<String, Object> params) {
    ...
    public static final class SortBySortBuilder {
      ...
      private final MeterListBuilder builder;

      SortBySortBuilder(String fieldName, MeterListBuilder builder) {
    ...
    public static final class SortDirection {
      ...
      SortDirection(String fieldName, String selectedField, MeterListBuilder builder) {
        this.fieldName = fieldName;
        this.selectedField = selectedField;
        this.builder = builder;
      }

      public MeterListBuilder asc() {
        builder.queryParams.put(fieldName + "[asc]", selectedField);
        return builder;
      }

      public MeterListBuilder desc() {
