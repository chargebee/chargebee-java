...
package com.chargebee.v4.models.meter;
...
public class Meter {
  ...
  public static Meter fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static Meter fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static Meter fromJson(JsonObject jsonObj) {
    Meter obj = new Meter();
