...
/**
 * Base class for all response objects. Provides common functionality for accessing HTTP response
 * metadata.
 */
public abstract class BaseResponse {
  ...
  /**
   * Check if this response is an idempotency replay. Returns true if the
   * chargebee-idempotency-replayed header is set to "true".
   *
