...
public final class CustomerAddPromotionalCreditsParams {
  ...
  private CustomerAddPromotionalCreditsParams(CustomerAddPromotionalCreditsBuilder builder) {
  ...
  /** Create a new builder for CustomerAddPromotionalCreditsParams. */
  @Recommended(reason = "Preferred for reusability, validation, and LLM-friendliness")
  public static CustomerAddPromotionalCreditsBuilder builder() {
    return new CustomerAddPromotionalCreditsBuilder();
  }

  public static final class CustomerAddPromotionalCreditsBuilder {
     ...
     */
    public CustomerAddPromotionalCreditsBuilder consentField(String fieldName, Object value) {
     ...
     * @throws IllegalArgumentException if fieldName doesn't start with "cs_"
     */
    public CustomerAddPromotionalCreditsBuilder consentField(String fieldName, Boolean value) {
      if (fieldName == null || !fieldName.startsWith("cs_")) {
        throw new IllegalArgumentException("Consent field name must start with 'cs_'");
      }
      this.consentFields.put(fieldName, value);
     ...
     */
    public CustomerAddPromotionalCreditsBuilder consentFields(Map<String, Object> consentFields) {
    ...
    public CustomerAddPromotionalCreditsParams build() {
      return new CustomerAddPromotionalCreditsParams(this);
    }
  }
