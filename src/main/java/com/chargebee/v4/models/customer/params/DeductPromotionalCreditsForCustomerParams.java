...
public final class DeductPromotionalCreditsForCustomerParams {
  ...
  private DeductPromotionalCreditsForCustomerParams(
      DeductPromotionalCreditsForCustomerBuilder builder) {
  ...
  /** Create a new builder for DeductPromotionalCreditsForCustomerParams. */
  @Recommended(reason = "Preferred for reusability, validation, and LLM-friendliness")
  public static DeductPromotionalCreditsForCustomerBuilder builder() {
    return new DeductPromotionalCreditsForCustomerBuilder();
  }

  public static final class DeductPromotionalCreditsForCustomerBuilder {
    ...
    private DeductPromotionalCreditsForCustomerBuilder() {}

    public DeductPromotionalCreditsForCustomerBuilder amount(Long value) {
      this.amount = value;
      return this;
    }

    public DeductPromotionalCreditsForCustomerBuilder currencyCode(String value) {
      this.currencyCode = value;
      return this;
    }

    public DeductPromotionalCreditsForCustomerBuilder description(String value) {
      this.description = value;
      return this;
    }

    public DeductPromotionalCreditsForCustomerBuilder creditType(CreditType value) {
      this.creditType = value;
      return this;
    }

    public DeductPromotionalCreditsForCustomerBuilder reference(String value) {
     ...
     */
    public DeductPromotionalCreditsForCustomerBuilder consentField(String fieldName, Object value) {
     ...
     * @throws IllegalArgumentException if fieldName doesn't start with "cs_"
     */
    public DeductPromotionalCreditsForCustomerBuilder consentField(
     ...
     */
    public DeductPromotionalCreditsForCustomerBuilder consentFields(
    ...
    public DeductPromotionalCreditsForCustomerParams build() {
      return new DeductPromotionalCreditsForCustomerParams(this);
    }
  }
