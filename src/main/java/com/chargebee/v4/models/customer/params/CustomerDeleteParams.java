...
public final class CustomerDeleteParams {
  ...
  public static final class CustomerDeleteBuilder {
     ...
     */
    public CustomerDeleteBuilder consentField(String fieldName, Object value) {
     ...
     * @throws IllegalArgumentException if fieldName doesn't start with "cs_"
     */
    public CustomerDeleteBuilder consentField(String fieldName, Boolean value) {
      if (fieldName == null || !fieldName.startsWith("cs_")) {
        throw new IllegalArgumentException("Consent field name must start with 'cs_'");
      }
      this.consentFields.put(fieldName, value);
     ...
     */
    public CustomerDeleteBuilder consentFields(Map<String, Object> consentFields) {
