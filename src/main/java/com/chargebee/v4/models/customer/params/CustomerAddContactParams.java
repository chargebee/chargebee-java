...
public final class CustomerAddContactParams {
  ...
  public static final class CustomerAddContactBuilder {
     ...
     */
    public CustomerAddContactBuilder consentField(String fieldName, Object value) {
     ...
     * @throws IllegalArgumentException if fieldName doesn't start with "cs_"
     */
    public CustomerAddContactBuilder consentField(String fieldName, Boolean value) {
      if (fieldName == null || !fieldName.startsWith("cs_")) {
        throw new IllegalArgumentException("Consent field name must start with 'cs_'");
      }
      this.consentFields.put(fieldName, value);
     ...
     */
    public CustomerAddContactBuilder consentFields(Map<String, Object> consentFields) {
