...
public final class CustomerAssignPaymentRoleParams {
  ...
  public static final class CustomerAssignPaymentRoleBuilder {
     ...
     */
    public CustomerAssignPaymentRoleBuilder consentField(String fieldName, Object value) {
     ...
     * @throws IllegalArgumentException if fieldName doesn't start with "cs_"
     */
    public CustomerAssignPaymentRoleBuilder consentField(String fieldName, Boolean value) {
      if (fieldName == null || !fieldName.startsWith("cs_")) {
        throw new IllegalArgumentException("Consent field name must start with 'cs_'");
      }
      this.consentFields.put(fieldName, value);
     ...
     */
    public CustomerAssignPaymentRoleBuilder consentFields(Map<String, Object> consentFields) {
