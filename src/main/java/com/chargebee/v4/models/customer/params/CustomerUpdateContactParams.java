...
public final class CustomerUpdateContactParams {
  ...
  public static final class CustomerUpdateContactBuilder {
     ...
     */
    public CustomerUpdateContactBuilder consentField(String fieldName, Object value) {
     ...
     * @throws IllegalArgumentException if fieldName doesn't start with "cs_"
     */
    public CustomerUpdateContactBuilder consentField(String fieldName, Boolean value) {
      if (fieldName == null || !fieldName.startsWith("cs_")) {
        throw new IllegalArgumentException("Consent field name must start with 'cs_'");
      }
      this.consentFields.put(fieldName, value);
     ...
     */
    public CustomerUpdateContactBuilder consentFields(Map<String, Object> consentFields) {
