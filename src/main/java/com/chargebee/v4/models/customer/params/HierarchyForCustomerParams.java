...
public final class HierarchyForCustomerParams {

  private final Map<String, Object> queryParams;

  private HierarchyForCustomerParams(HierarchyForCustomerBuilder builder) {
  ...
  public HierarchyForCustomerBuilder toBuilder() {
    HierarchyForCustomerBuilder builder = new HierarchyForCustomerBuilder();
    builder.queryParams.putAll(queryParams);
    return builder;
  }

  /** Create a new builder for HierarchyForCustomerParams. */
  @Recommended(reason = "Preferred for reusability, validation, and LLM-friendliness")
  public static HierarchyForCustomerBuilder builder() {
    return new HierarchyForCustomerBuilder();
  }

  public static final class HierarchyForCustomerBuilder {
    private final Map<String, Object> queryParams = new LinkedHashMap<>();

    private HierarchyForCustomerBuilder() {}

    public HierarchyForCustomerBuilder hierarchyOperationType(HierarchyOperationType value) {
      queryParams.put("hierarchy_operation_type", value);
      return this;
    }

    public HierarchyForCustomerParams build() {
      return new HierarchyForCustomerParams(this);
    }
  }
