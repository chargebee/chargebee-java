...
public final class SetPromotionalCreditsForCustomerParams {
  ...
  public static final class SetPromotionalCreditsForCustomerBuilder {
     ...
     */
    public SetPromotionalCreditsForCustomerBuilder consentField(String fieldName, Object value) {
     ...
     * @throws IllegalArgumentException if fieldName doesn't start with "cs_"
     */
    public SetPromotionalCreditsForCustomerBuilder consentField(String fieldName, Boolean value) {
      if (fieldName == null || !fieldName.startsWith("cs_")) {
        throw new IllegalArgumentException("Consent field name must start with 'cs_'");
      }
      this.consentFields.put(fieldName, value);
     ...
     */
    public SetPromotionalCreditsForCustomerBuilder consentFields(
