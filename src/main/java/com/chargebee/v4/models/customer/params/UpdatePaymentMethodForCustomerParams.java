...
public final class UpdatePaymentMethodForCustomerParams {
  ...
  public static final class UpdatePaymentMethodForCustomerBuilder {
     ...
     */
    public UpdatePaymentMethodForCustomerBuilder consentField(String fieldName, Object value) {
     ...
     * @throws IllegalArgumentException if fieldName doesn't start with "cs_"
     */
    public UpdatePaymentMethodForCustomerBuilder consentField(String fieldName, Boolean value) {
      if (fieldName == null || !fieldName.startsWith("cs_")) {
        throw new IllegalArgumentException("Consent field name must start with 'cs_'");
      }
      this.consentFields.put(fieldName, value);
     ...
     */
    public UpdatePaymentMethodForCustomerBuilder consentFields(Map<String, Object> consentFields) {
