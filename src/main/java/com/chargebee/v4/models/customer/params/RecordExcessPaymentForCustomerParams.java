...
public final class RecordExcessPaymentForCustomerParams {
  ...
  private RecordExcessPaymentForCustomerParams(RecordExcessPaymentForCustomerBuilder builder) {
  ...
  /** Create a new builder for RecordExcessPaymentForCustomerParams. */
  @Recommended(reason = "Preferred for reusability, validation, and LLM-friendliness")
  public static RecordExcessPaymentForCustomerBuilder builder() {
    return new RecordExcessPaymentForCustomerBuilder();
  }

  public static final class RecordExcessPaymentForCustomerBuilder {
    ...
    private RecordExcessPaymentForCustomerBuilder() {}

    public RecordExcessPaymentForCustomerBuilder comment(String value) {
      this.comment = value;
      return this;
    }

    public RecordExcessPaymentForCustomerBuilder transaction(TransactionParams value) {
     ...
     */
    public RecordExcessPaymentForCustomerBuilder consentField(String fieldName, Object value) {
     ...
     * @throws IllegalArgumentException if fieldName doesn't start with "cs_"
     */
    public RecordExcessPaymentForCustomerBuilder consentField(String fieldName, Boolean value) {
      if (fieldName == null || !fieldName.startsWith("cs_")) {
        throw new IllegalArgumentException("Consent field name must start with 'cs_'");
      }
      this.consentFields.put(fieldName, value);
     ...
     */
    public RecordExcessPaymentForCustomerBuilder consentFields(Map<String, Object> consentFields) {
    ...
    public RecordExcessPaymentForCustomerParams build() {
      return new RecordExcessPaymentForCustomerParams(this);
    }
  }
