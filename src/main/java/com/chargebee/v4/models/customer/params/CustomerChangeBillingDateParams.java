...
public final class CustomerChangeBillingDateParams {
  ...
  private CustomerChangeBillingDateParams(CustomerChangeBillingDateBuilder builder) {
  ...
  /** Create a new builder for CustomerChangeBillingDateParams. */
  @Recommended(reason = "Preferred for reusability, validation, and LLM-friendliness")
  public static CustomerChangeBillingDateBuilder builder() {
    return new CustomerChangeBillingDateBuilder();
  }

  public static final class CustomerChangeBillingDateBuilder {
     ...
     */
    public CustomerChangeBillingDateBuilder consentField(String fieldName, Object value) {
     ...
     * @throws IllegalArgumentException if fieldName doesn't start with "cs_"
     */
    public CustomerChangeBillingDateBuilder consentField(String fieldName, Boolean value) {
      if (fieldName == null || !fieldName.startsWith("cs_")) {
        throw new IllegalArgumentException("Consent field name must start with 'cs_'");
      }
      this.consentFields.put(fieldName, value);
     ...
     */
    public CustomerChangeBillingDateBuilder consentFields(Map<String, Object> consentFields) {
