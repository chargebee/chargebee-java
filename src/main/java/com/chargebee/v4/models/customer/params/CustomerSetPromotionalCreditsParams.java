...
public final class CustomerSetPromotionalCreditsParams {
  ...
  private CustomerSetPromotionalCreditsParams(CustomerSetPromotionalCreditsBuilder builder) {
  ...
  /** Create a new builder for CustomerSetPromotionalCreditsParams. */
  @Recommended(reason = "Preferred for reusability, validation, and LLM-friendliness")
  public static CustomerSetPromotionalCreditsBuilder builder() {
    return new CustomerSetPromotionalCreditsBuilder();
  }

  public static final class CustomerSetPromotionalCreditsBuilder {
    ...
    private CustomerSetPromotionalCreditsBuilder() {}

    public CustomerSetPromotionalCreditsBuilder amount(Long value) {
      this.amount = value;
      return this;
    }

    public CustomerSetPromotionalCreditsBuilder currencyCode(String value) {
      this.currencyCode = value;
      return this;
    }

    public CustomerSetPromotionalCreditsBuilder description(String value) {
      this.description = value;
      return this;
    }

    public CustomerSetPromotionalCreditsBuilder creditType(CreditType value) {
      this.creditType = value;
      return this;
    }

    public CustomerSetPromotionalCreditsBuilder reference(String value) {
     ...
     */
    public CustomerSetPromotionalCreditsBuilder consentField(String fieldName, Object value) {
     ...
     * @throws IllegalArgumentException if fieldName doesn't start with "cs_"
     */
    public CustomerSetPromotionalCreditsBuilder consentField(String fieldName, Boolean value) {
      if (fieldName == null || !fieldName.startsWith("cs_")) {
        throw new IllegalArgumentException("Consent field name must start with 'cs_'");
      }
      this.consentFields.put(fieldName, value);
     ...
     */
    public CustomerSetPromotionalCreditsBuilder consentFields(Map<String, Object> consentFields) {
    ...
    public CustomerSetPromotionalCreditsParams build() {
      return new CustomerSetPromotionalCreditsParams(this);
    }
  }
