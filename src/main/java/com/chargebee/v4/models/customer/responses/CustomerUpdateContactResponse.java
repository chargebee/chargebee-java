 ...
 * the API.
 */
public final class CustomerUpdateContactResponse extends BaseResponse {
  ...
  public String toString() {
    return "CustomerUpdateContactResponse{" + "customer=" + customer + ", card=" + card + "}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CustomerUpdateContactResponse that = (CustomerUpdateContactResponse) o;
