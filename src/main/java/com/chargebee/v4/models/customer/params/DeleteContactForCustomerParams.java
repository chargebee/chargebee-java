...
public final class DeleteContactForCustomerParams {
  ...
  public static final class DeleteContactForCustomerBuilder {
     ...
     */
    public DeleteContactForCustomerBuilder consentField(String fieldName, Object value) {
     ...
     * @throws IllegalArgumentException if fieldName doesn't start with "cs_"
     */
    public DeleteContactForCustomerBuilder consentField(String fieldName, Boolean value) {
      if (fieldName == null || !fieldName.startsWith("cs_")) {
        throw new IllegalArgumentException("Consent field name must start with 'cs_'");
      }
      this.consentFields.put(fieldName, value);
     ...
     */
    public DeleteContactForCustomerBuilder consentFields(Map<String, Object> consentFields) {
