 ...
 */
public final class CustomerDeleteResponse extends BaseResponse {
  private final Customer customer;

  private final Card card;

  private CustomerDeleteResponse(Builder builder) {
  ...
  /** Parse JSON response into CustomerDeleteResponse object. */
  public static CustomerDeleteResponse fromJson(String json) {
  ...
  public static CustomerDeleteResponse fromJson(String json, Response httpResponse) {
    try {
      ...
      throw new RuntimeException("Failed to parse CustomerDeleteResponse from JSON", e);
    }
  }

  /** Create a new builder for CustomerDeleteResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for CustomerDeleteResponse. */
  public static class Builder {
    ...
    public CustomerDeleteResponse build() {
      return new CustomerDeleteResponse(this);
    }
  }
  ...
  public String toString() {
    return "CustomerDeleteResponse{" + "customer=" + customer + ", card=" + card + "}";
  }
