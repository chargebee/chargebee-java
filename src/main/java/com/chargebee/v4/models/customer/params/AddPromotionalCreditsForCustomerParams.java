...
public final class AddPromotionalCreditsForCustomerParams {
  ...
  private AddPromotionalCreditsForCustomerParams(AddPromotionalCreditsForCustomerBuilder builder) {
  ...
  /** Create a new builder for AddPromotionalCreditsForCustomerParams. */
  @Recommended(reason = "Preferred for reusability, validation, and LLM-friendliness")
  public static AddPromotionalCreditsForCustomerBuilder builder() {
    return new AddPromotionalCreditsForCustomerBuilder();
  }

  public static final class AddPromotionalCreditsForCustomerBuilder {
    ...
    private AddPromotionalCreditsForCustomerBuilder() {}

    public AddPromotionalCreditsForCustomerBuilder amount(Long value) {
      this.amount = value;
      return this;
    }

    public AddPromotionalCreditsForCustomerBuilder currencyCode(String value) {
      this.currencyCode = value;
      return this;
    }

    public AddPromotionalCreditsForCustomerBuilder description(String value) {
      this.description = value;
      return this;
    }

    public AddPromotionalCreditsForCustomerBuilder creditType(CreditType value) {
      this.creditType = value;
      return this;
    }

    public AddPromotionalCreditsForCustomerBuilder reference(String value) {
     ...
     */
    public AddPromotionalCreditsForCustomerBuilder consentField(String fieldName, Object value) {
     ...
     * @throws IllegalArgumentException if fieldName doesn't start with "cs_"
     */
    public AddPromotionalCreditsForCustomerBuilder consentField(String fieldName, Boolean value) {
      if (fieldName == null || !fieldName.startsWith("cs_")) {
        throw new IllegalArgumentException("Consent field name must start with 'cs_'");
      }
      this.consentFields.put(fieldName, value);
     ...
     */
    public AddPromotionalCreditsForCustomerBuilder consentFields(
    ...
    public AddPromotionalCreditsForCustomerParams build() {
      return new AddPromotionalCreditsForCustomerParams(this);
    }
  }
