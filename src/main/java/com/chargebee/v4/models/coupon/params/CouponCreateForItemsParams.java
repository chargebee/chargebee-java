...
public final class CouponCreateForItemsParams {
  ...
  public static final class CouponCreateForItemsBuilder {
    ...
    public CouponCreateForItemsBuilder discountPercentage(Double value) {
     ...
     */
    public CouponCreateForItemsBuilder customField(String fieldName, String value) {
     ...
     */
    public CouponCreateForItemsBuilder customFields(Map<String, String> customFields) {
