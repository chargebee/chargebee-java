...
public final class CouponListResponse {
  ...
  public static CouponListResponse fromJson(String json) {
    try {
      ...
      List<CouponListItem> list =
          JsonUtil.mapArray(JsonUtil.getJsonArray(jsonObj, "list"), CouponListItem::fromJson);
