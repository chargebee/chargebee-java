 ...
 */
public final class CouponUnarchiveResponse extends BaseResponse {
  ...
  /** Parse JSON response into CouponUnarchiveResponse object with HTTP response. */
  public static CouponUnarchiveResponse fromJson(String json, Response httpResponse) {
    try {
  ...
  public String toString() {
    return "CouponUnarchiveResponse{" + "coupon=" + coupon + "}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CouponUnarchiveResponse that = (CouponUnarchiveResponse) o;
