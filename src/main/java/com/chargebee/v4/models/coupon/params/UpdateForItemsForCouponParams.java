...
public final class UpdateForItemsForCouponParams {
  ...
  public static final class UpdateForItemsForCouponBuilder {
    ...
    public UpdateForItemsForCouponBuilder metaData(java.util.Map<String, Object> value) {
      this.metaData = value;
      return this;
    }
    ...
    public UpdateForItemsForCouponBuilder itemConstraints(List<ItemConstraintsParams> value) {
    ...
    public UpdateForItemsForCouponBuilder couponConstraints(List<CouponConstraintsParams> value) {
