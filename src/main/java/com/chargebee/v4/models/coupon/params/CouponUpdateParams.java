...
public final class CouponUpdateParams {
  ...
  private CouponUpdateParams(CouponUpdateBuilder builder) {
  ...
  /** Create a new builder for CouponUpdateParams. */
  ...
  public static final class CouponUpdateBuilder {
    ...
    public CouponUpdateBuilder discountPercentage(Double value) {
