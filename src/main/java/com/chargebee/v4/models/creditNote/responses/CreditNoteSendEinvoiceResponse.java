 ...
 * the API.
 */
public final class CreditNoteSendEinvoiceResponse extends BaseResponse {
  ...
  public String toString() {
    return "CreditNoteSendEinvoiceResponse{" + "creditNote=" + creditNote + "}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CreditNoteSendEinvoiceResponse that = (CreditNoteSendEinvoiceResponse) o;
