...
public final class CreditNoteUpdateParams {

  private final String comment;

  private final Map<String, String> customFields;

  private CreditNoteUpdateParams(CreditNoteUpdateBuilder builder) {
  ...
  /** Create a new builder for CreditNoteUpdateParams. */
  @Recommended(reason = "Preferred for reusability, validation, and LLM-friendliness")
  public static CreditNoteUpdateBuilder builder() {
    return new CreditNoteUpdateBuilder();
  }

  public static final class CreditNoteUpdateBuilder {

    private String comment;

    private Map<String, String> customFields = new LinkedHashMap<>();

    private CreditNoteUpdateBuilder() {}

    public CreditNoteUpdateBuilder comment(String value) {
      this.comment = value;
      return this;
    }
     ...
     */
    public CreditNoteUpdateBuilder customField(String fieldName, String value) {
     ...
     */
    public CreditNoteUpdateBuilder customFields(Map<String, String> customFields) {
    ...
    public CreditNoteUpdateParams build() {
      return new CreditNoteUpdateParams(this);
    }
  }
}
