...
public final class PdfForCreditNoteParams {

  private final DispositionType dispositionType;

  private PdfForCreditNoteParams(PdfForCreditNoteBuilder builder) {
  ...
  /** Create a new builder for PdfForCreditNoteParams. */
  @Recommended(reason = "Preferred for reusability, validation, and LLM-friendliness")
  public static PdfForCreditNoteBuilder builder() {
    return new PdfForCreditNoteBuilder();
  }

  public static final class PdfForCreditNoteBuilder {

    private DispositionType dispositionType;

    private PdfForCreditNoteBuilder() {}

    public PdfForCreditNoteBuilder dispositionType(DispositionType value) {
      this.dispositionType = value;
      return this;
    }

    public PdfForCreditNoteParams build() {
      return new PdfForCreditNoteParams(this);
    }
  }
