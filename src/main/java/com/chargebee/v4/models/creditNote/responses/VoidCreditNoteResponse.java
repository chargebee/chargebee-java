 ...
 */
public final class VoidCreditNoteResponse extends BaseResponse {
  private final CreditNote creditNote;

  private VoidCreditNoteResponse(Builder builder) {
    super(builder.httpResponse);

    this.creditNote = builder.creditNote;
  }

  /** Parse JSON response into VoidCreditNoteResponse object. */
  public static VoidCreditNoteResponse fromJson(String json) {
  ...
  public static VoidCreditNoteResponse fromJson(String json, Response httpResponse) {
    try {
      ...
      throw new RuntimeException("Failed to parse VoidCreditNoteResponse from JSON", e);
    }
  }

  /** Create a new builder for VoidCreditNoteResponse. */
  public static Builder builder() {
    return new Builder();
  }

  /** Builder for VoidCreditNoteResponse. */
  public static class Builder {
    ...
    public VoidCreditNoteResponse build() {
      return new VoidCreditNoteResponse(this);
    }
  }
  ...
  public String toString() {
    return "VoidCreditNoteResponse{" + "creditNote=" + creditNote + "}";
  }
  ...
  public boolean equals(Object o) {
    ...
    VoidCreditNoteResponse that = (VoidCreditNoteResponse) o;
