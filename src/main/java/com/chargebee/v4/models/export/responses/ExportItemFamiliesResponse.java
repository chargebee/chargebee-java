 ...
 * API.
 */
public final class ExportItemFamiliesResponse extends BaseResponse {
  ...
  /** Parse JSON response into ExportItemFamiliesResponse object with HTTP response. */
  public static ExportItemFamiliesResponse fromJson(String json, Response httpResponse) {
    try {
  ...
  public String toString() {
    return "ExportItemFamiliesResponse{" + "export=" + export + "}";
  }
  ...
  public boolean equals(Object o) {
    ...
    ExportItemFamiliesResponse that = (ExportItemFamiliesResponse) o;
