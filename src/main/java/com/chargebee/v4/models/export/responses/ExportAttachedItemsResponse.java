 ...
 * API.
 */
public final class ExportAttachedItemsResponse extends BaseResponse {
  ...
  /** Parse JSON response into ExportAttachedItemsResponse object with HTTP response. */
  public static ExportAttachedItemsResponse fromJson(String json, Response httpResponse) {
    try {
  ...
  public String toString() {
    return "ExportAttachedItemsResponse{" + "export=" + export + "}";
  }
  ...
  public boolean equals(Object o) {
    ...
    ExportAttachedItemsResponse that = (ExportAttachedItemsResponse) o;
