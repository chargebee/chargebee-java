 ...
 */
public final class ExportInvoicesResponse extends BaseResponse {
  ...
  /** Parse JSON response into ExportInvoicesResponse object with HTTP response. */
  public static ExportInvoicesResponse fromJson(String json, Response httpResponse) {
    try {
  ...
  public String toString() {
    return "ExportInvoicesResponse{" + "export=" + export + "}";
  }
  ...
  public boolean equals(Object o) {
    ...
    ExportInvoicesResponse that = (ExportInvoicesResponse) o;
