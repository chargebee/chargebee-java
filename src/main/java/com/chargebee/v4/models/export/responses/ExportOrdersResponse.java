 ...
 */
public final class ExportOrdersResponse extends BaseResponse {
  ...
  /** Parse JSON response into ExportOrdersResponse object with HTTP response. */
  public static ExportOrdersResponse fromJson(String json, Response httpResponse) {
    try {
  ...
  public String toString() {
    return "ExportOrdersResponse{" + "export=" + export + "}";
  }
  ...
  public boolean equals(Object o) {
    ...
    ExportOrdersResponse that = (ExportOrdersResponse) o;
