 ...
 * API.
 */
public final class ExportItemPricesResponse extends BaseResponse {
  ...
  public String toString() {
    return "ExportItemPricesResponse{" + "export=" + export + "}";
  }
  ...
  public boolean equals(Object o) {
    ...
    ExportItemPricesResponse that = (ExportItemPricesResponse) o;
