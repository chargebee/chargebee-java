...
public final class AlertListParams {

  private final Map<String, Object> queryParams;

  private AlertListParams(AlertListBuilder builder) {
  ...
  public AlertListBuilder toBuilder() {
    AlertListBuilder builder = new AlertListBuilder();
    builder.queryParams.putAll(queryParams);
    return builder;
  }

  /** Create a new builder for AlertListParams. */
  @Recommended(reason = "Preferred for reusability, validation, and LLM-friendliness")
  public static AlertListBuilder builder() {
    return new AlertListBuilder();
  }

  public static final class AlertListBuilder {
    private final Map<String, Object> queryParams = new LinkedHashMap<>();

    private AlertListBuilder() {}

    public AlertListBuilder limit(Integer value) {
      queryParams.put("limit", value);
      return this;
    }

    public AlertListBuilder offset(String value) {
    ...
    public AlertListParams build() {
      return new AlertListParams(this);
    }

    public static final class IdFilter extends StringFilter<AlertListBuilder> {
      IdFilter(String fieldName, AlertListBuilder builder, Map<String, Object> params) {
        super(fieldName, builder, params);
      }
    }

    public static final class TypeFilter extends EnumFilter<Type, AlertListBuilder> {
      TypeFilter(String fieldName, AlertListBuilder builder, Map<String, Object> params) {
       ...
       */
      @Deprecated
      public AlertListBuilder is(String value) {
       ...
       */
      @Deprecated
      public AlertListBuilder isNot(String value) {
       ...
       */
      @Deprecated
      public AlertListBuilder in(String... values) {
       ...
       */
      @Deprecated
      public AlertListBuilder notIn(String... values) {
        params.put(fieldName + "[not_in]", "[" + String.join(",", values) + "]");
        return builder;
      }
    }

    public static final class SubscriptionIdFilter extends StringFilter<AlertListBuilder> {
      SubscriptionIdFilter(String fieldName, AlertListBuilder builder, Map<String, Object> params) {
        super(fieldName, builder, params);
      }
    }

    public static final class StatusFilter extends EnumFilter<Status, AlertListBuilder> {
      StatusFilter(String fieldName, AlertListBuilder builder, Map<String, Object> params) {
