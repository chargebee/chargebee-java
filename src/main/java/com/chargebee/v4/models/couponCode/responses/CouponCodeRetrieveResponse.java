...
public final class CouponCodeRetrieveResponse extends BaseResponse {
  ...
  public static CouponCodeRetrieveResponse fromJson(String json, Response httpResponse) {
    try {
      ...
      if (__couponCodeObj != null) {
        builder.couponCode(CouponCode.fromJson(__couponCodeObj));
      }
  ...
  public String toString() {
    return "CouponCodeRetrieveResponse{" + "couponCode=" + couponCode + "}";
  }
  ...
  public boolean equals(Object o) {
    ...
    CouponCodeRetrieveResponse that = (CouponCodeRetrieveResponse) o;
