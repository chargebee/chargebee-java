 ...
 */
public final class VariantUpdateResponse extends BaseResponse {
  ...
  public String toString() {
    return "VariantUpdateResponse{" + "variant=" + variant + "}";
  }
  ...
  public boolean equals(Object o) {
    ...
    VariantUpdateResponse that = (VariantUpdateResponse) o;
