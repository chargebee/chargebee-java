...
public final class UsageFileProcessingStatusResponse extends BaseResponse {
  ...
  private UsageFileProcessingStatusResponse(Builder builder) {
  ...
  /** Builder for UsageFileProcessingStatusResponse. */
  public static class Builder {
    ...
    public UsageFileProcessingStatusResponse build() {
      return new UsageFileProcessingStatusResponse(this);
    }
  }
  ...
  public String toString() {
    return "UsageFileProcessingStatusResponse{" + "usageFile=" + usageFile + "}";
  }
  ...
  public boolean equals(Object o) {
    ...
    UsageFileProcessingStatusResponse that = (UsageFileProcessingStatusResponse) o;
