...
public class VaultTokenDeletedEvent {
  ...
  public static VaultTokenDeletedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static VaultTokenDeletedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static VaultTokenDeletedEvent fromJson(JsonObject jsonObj) {
    VaultTokenDeletedEvent obj = new VaultTokenDeletedEvent();
  ...
  public boolean equals(Object o) {
    ...
    VaultTokenDeletedEvent that = (VaultTokenDeletedEvent) o;
