...
public class GiftExpiredEvent {
  ...
  public static GiftExpiredEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static GiftExpiredEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static GiftExpiredEvent fromJson(JsonObject jsonObj) {
    GiftExpiredEvent obj = new GiftExpiredEvent();
  ...
  public boolean equals(Object o) {
    ...
    GiftExpiredEvent that = (GiftExpiredEvent) o;
