...
public class PaymentIntentUpdatedEvent {
  ...
  public static PaymentIntentUpdatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static PaymentIntentUpdatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static PaymentIntentUpdatedEvent fromJson(JsonObject jsonObj) {
    PaymentIntentUpdatedEvent obj = new PaymentIntentUpdatedEvent();
  ...
  public boolean equals(Object o) {
    ...
    PaymentIntentUpdatedEvent that = (PaymentIntentUpdatedEvent) o;
  ...
  public static class Content {
    ...
    public static Content fromJson(JsonObject jsonObj) {
      ...
      if (__paymentIntentObj != null) {
        obj.paymentIntent = PaymentIntent.fromJson(__paymentIntentObj);
      }
    ...
    @Override
    public String toString() {
      return "Content{" + "paymentIntent=" + paymentIntent + "}";
    }
