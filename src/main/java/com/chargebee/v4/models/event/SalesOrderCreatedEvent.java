...
import com.chargebee.v4.models.salesOrder.SalesOrder;
...
public class SalesOrderCreatedEvent {
  ...
  public static SalesOrderCreatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static SalesOrderCreatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static SalesOrderCreatedEvent fromJson(JsonObject jsonObj) {
    SalesOrderCreatedEvent obj = new SalesOrderCreatedEvent();
  ...
  public boolean equals(Object o) {
    ...
    SalesOrderCreatedEvent that = (SalesOrderCreatedEvent) o;
  ...
  public static class Content {
    ...
    public static Content fromJson(JsonObject jsonObj) {
      ...
      JsonObject __salesOrderObj = JsonUtil.getJsonObject(jsonObj, "sales_order");
      if (__salesOrderObj != null) {
        obj.salesOrder = SalesOrder.fromJson(__salesOrderObj);
      }
    ...
    @Override
    public String toString() {
      return "Content{" + "salesOrder=" + salesOrder + "}";
    }
    ...
    public boolean equals(Object o) {
      ...
      return java.util.Objects.equals(salesOrder, that.salesOrder);
    }

    @Override
    public int hashCode() {

      return java.util.Objects.hash(salesOrder);
    }
  }
}
