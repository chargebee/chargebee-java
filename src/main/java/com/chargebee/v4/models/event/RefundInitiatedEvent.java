...
public class RefundInitiatedEvent {
  ...
  public static RefundInitiatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static RefundInitiatedEvent fromJson(JsonObject jsonObj) {
  ...
  public boolean equals(Object o) {
    ...
    RefundInitiatedEvent that = (RefundInitiatedEvent) o;
  ...
  public static class Content {
    ...
    public int hashCode() {
      ...
      return java.util.Objects.hash(transaction, invoice, creditNote, customer, subscription, card);
    }
  }
}
