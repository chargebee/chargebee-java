...
public class EinvoiceCreatedEvent {
  ...
  public static EinvoiceCreatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static EinvoiceCreatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static EinvoiceCreatedEvent fromJson(JsonObject jsonObj) {
    EinvoiceCreatedEvent obj = new EinvoiceCreatedEvent();
  ...
  public boolean equals(Object o) {
    ...
    EinvoiceCreatedEvent that = (EinvoiceCreatedEvent) o;
