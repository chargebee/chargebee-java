...
public class AddonCreatedEvent {
  ...
  public static AddonCreatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static AddonCreatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static AddonCreatedEvent fromJson(JsonObject jsonObj) {
    AddonCreatedEvent obj = new AddonCreatedEvent();
  ...
  public boolean equals(Object o) {
    ...
    AddonCreatedEvent that = (AddonCreatedEvent) o;
  ...
  public static class Content {
    ...
    public static Content fromJson(JsonObject jsonObj) {
      ...
      if (__addonObj != null) {
        obj.addon = Addon.fromJson(__addonObj);
      }
