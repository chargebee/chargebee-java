...
public class MrrUpdatedEvent {
  ...
  public static MrrUpdatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static MrrUpdatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static MrrUpdatedEvent fromJson(JsonObject jsonObj) {
    MrrUpdatedEvent obj = new MrrUpdatedEvent();
  ...
  public boolean equals(Object o) {
    ...
    MrrUpdatedEvent that = (MrrUpdatedEvent) o;
