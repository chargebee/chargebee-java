...
public class BusinessRulesetActivatedEvent {
  ...
  public static BusinessRulesetActivatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static BusinessRulesetActivatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static BusinessRulesetActivatedEvent fromJson(JsonObject jsonObj) {
    BusinessRulesetActivatedEvent obj = new BusinessRulesetActivatedEvent();
  ...
  public String toString() {
    return "BusinessRulesetActivatedEvent{"
        + "id="
        + id
        + ", occurredAt="
        + occurredAt
  ...
  public boolean equals(Object o) {
    ...
    BusinessRulesetActivatedEvent that = (BusinessRulesetActivatedEvent) o;
