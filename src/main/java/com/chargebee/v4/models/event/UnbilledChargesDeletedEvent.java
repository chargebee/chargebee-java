...
public class UnbilledChargesDeletedEvent {
  ...
  public static UnbilledChargesDeletedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static UnbilledChargesDeletedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static UnbilledChargesDeletedEvent fromJson(JsonObject jsonObj) {
    UnbilledChargesDeletedEvent obj = new UnbilledChargesDeletedEvent();
  ...
  public boolean equals(Object o) {
    ...
    UnbilledChargesDeletedEvent that = (UnbilledChargesDeletedEvent) o;
  ...
  public static class Content {
    ...
    @Override
    public String toString() {
      return "Content{" + "unbilledCharges=" + unbilledCharges + "}";
    }
