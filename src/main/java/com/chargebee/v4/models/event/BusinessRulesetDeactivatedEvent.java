...
public class BusinessRulesetDeactivatedEvent {
  ...
  public static BusinessRulesetDeactivatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static BusinessRulesetDeactivatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static BusinessRulesetDeactivatedEvent fromJson(JsonObject jsonObj) {
    BusinessRulesetDeactivatedEvent obj = new BusinessRulesetDeactivatedEvent();
  ...
  public String toString() {
    return "BusinessRulesetDeactivatedEvent{"
        + "id="
        + id
        + ", occurredAt="
        + occurredAt
  ...
  public boolean equals(Object o) {
    ...
    BusinessRulesetDeactivatedEvent that = (BusinessRulesetDeactivatedEvent) o;
  ...
  public static class Content {
    ...
    public static Content fromJson(JsonObject jsonObj) {
      ...
      if (__businessRulesetObj != null) {
        obj.businessRuleset = BusinessRuleset.fromJson(__businessRulesetObj);
      }
    ...
    @Override
    public String toString() {
      return "Content{" + "businessRuleset=" + businessRuleset + "}";
    }
