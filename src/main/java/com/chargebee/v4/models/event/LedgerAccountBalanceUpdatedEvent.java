...
public class LedgerAccountBalanceUpdatedEvent {
  ...
  public static LedgerAccountBalanceUpdatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static LedgerAccountBalanceUpdatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static LedgerAccountBalanceUpdatedEvent fromJson(JsonObject jsonObj) {
    LedgerAccountBalanceUpdatedEvent obj = new LedgerAccountBalanceUpdatedEvent();
  ...
  public String toString() {
    return "LedgerAccountBalanceUpdatedEvent{"
        + "id="
        + id
        + ", occurredAt="
        + occurredAt
  ...
  public boolean equals(Object o) {
    ...
    LedgerAccountBalanceUpdatedEvent that = (LedgerAccountBalanceUpdatedEvent) o;
  ...
  public static class Content {
    ...
    public static Content fromJson(JsonObject jsonObj) {
      ...
      if (__ledgerAccountBalanceObj != null) {
        obj.ledgerAccountBalance = LedgerAccountBalance.fromJson(__ledgerAccountBalanceObj);
      }
    ...
    @Override
    public String toString() {
      return "Content{" + "ledgerAccountBalance=" + ledgerAccountBalance + "}";
    }
