...
public class OrderReadyToShipEvent {
  ...
  public static OrderReadyToShipEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static OrderReadyToShipEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static OrderReadyToShipEvent fromJson(JsonObject jsonObj) {
    OrderReadyToShipEvent obj = new OrderReadyToShipEvent();
  ...
  public boolean equals(Object o) {
    ...
    OrderReadyToShipEvent that = (OrderReadyToShipEvent) o;
  ...
  public static class Content {
    ...
    public static Content fromJson(JsonObject jsonObj) {
      ...
      if (__orderObj != null) {
        obj.order = Order.fromJson(__orderObj);
      }
