...
public class NetdPaymentDueReminderEvent {
  ...
  public static NetdPaymentDueReminderEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static NetdPaymentDueReminderEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static NetdPaymentDueReminderEvent fromJson(JsonObject jsonObj) {
    NetdPaymentDueReminderEvent obj = new NetdPaymentDueReminderEvent();
  ...
  public String toString() {
    return "NetdPaymentDueReminderEvent{"
        + "id="
        + id
        + ", occurredAt="
        + occurredAt
  ...
  public boolean equals(Object o) {
    ...
    NetdPaymentDueReminderEvent that = (NetdPaymentDueReminderEvent) o;
