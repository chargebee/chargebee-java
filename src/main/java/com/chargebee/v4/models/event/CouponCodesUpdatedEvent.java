...
public class CouponCodesUpdatedEvent {
  ...
  public static CouponCodesUpdatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static CouponCodesUpdatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static CouponCodesUpdatedEvent fromJson(JsonObject jsonObj) {
    CouponCodesUpdatedEvent obj = new CouponCodesUpdatedEvent();
  ...
  public boolean equals(Object o) {
    ...
    CouponCodesUpdatedEvent that = (CouponCodesUpdatedEvent) o;
