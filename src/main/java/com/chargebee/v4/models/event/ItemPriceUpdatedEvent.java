...
public class ItemPriceUpdatedEvent {
  ...
  public static ItemPriceUpdatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static ItemPriceUpdatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static ItemPriceUpdatedEvent fromJson(JsonObject jsonObj) {
    ItemPriceUpdatedEvent obj = new ItemPriceUpdatedEvent();
  ...
  public boolean equals(Object o) {
    ...
    ItemPriceUpdatedEvent that = (ItemPriceUpdatedEvent) o;
  ...
  public static class Content {
    ...
    public static Content fromJson(JsonObject jsonObj) {
      ...
      if (__itemPriceObj != null) {
        obj.itemPrice = ItemPrice.fromJson(__itemPriceObj);
      }
    ...
    @Override
    public String toString() {
      return "Content{" + "itemPrice=" + itemPrice + "}";
    }
