...
public class DifferentialPriceDeletedEvent {
  ...
  public static DifferentialPriceDeletedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static DifferentialPriceDeletedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static DifferentialPriceDeletedEvent fromJson(JsonObject jsonObj) {
    DifferentialPriceDeletedEvent obj = new DifferentialPriceDeletedEvent();
  ...
  public boolean equals(Object o) {
    ...
    DifferentialPriceDeletedEvent that = (DifferentialPriceDeletedEvent) o;
  ...
  public static class Content {
    ...
    public static Content fromJson(JsonObject jsonObj) {
      ...
      if (__differentialPriceObj != null) {
        obj.differentialPrice = DifferentialPrice.fromJson(__differentialPriceObj);
      }
    ...
    @Override
    public String toString() {
      return "Content{" + "differentialPrice=" + differentialPrice + "}";
    }
