...
public class SubscriptionRampAppliedEvent {
  ...
  public static SubscriptionRampAppliedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static SubscriptionRampAppliedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static SubscriptionRampAppliedEvent fromJson(JsonObject jsonObj) {
    SubscriptionRampAppliedEvent obj = new SubscriptionRampAppliedEvent();
  ...
  public boolean equals(Object o) {
    ...
    SubscriptionRampAppliedEvent that = (SubscriptionRampAppliedEvent) o;
  ...
  public static class Content {
    ...
    public static Content fromJson(JsonObject jsonObj) {
      ...
      if (__rampObj != null) {
        obj.ramp = Ramp.fromJson(__rampObj);
      }
