...
public class VoucherCreatedEvent {
  ...
  public static VoucherCreatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static VoucherCreatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static VoucherCreatedEvent fromJson(JsonObject jsonObj) {
    VoucherCreatedEvent obj = new VoucherCreatedEvent();
  ...
  public boolean equals(Object o) {
    ...
    VoucherCreatedEvent that = (VoucherCreatedEvent) o;
