...
public class GiftScheduledEvent {
  ...
  public static GiftScheduledEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static GiftScheduledEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static GiftScheduledEvent fromJson(JsonObject jsonObj) {
    GiftScheduledEvent obj = new GiftScheduledEvent();
  ...
  public boolean equals(Object o) {
    ...
    GiftScheduledEvent that = (GiftScheduledEvent) o;
