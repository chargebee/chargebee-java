...
public class ProductCreatedEvent {
  ...
  public static ProductCreatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static ProductCreatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static ProductCreatedEvent fromJson(JsonObject jsonObj) {
    ProductCreatedEvent obj = new ProductCreatedEvent();
