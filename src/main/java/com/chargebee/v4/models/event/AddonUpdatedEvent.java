...
public class AddonUpdatedEvent {
  ...
  public static AddonUpdatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static AddonUpdatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static AddonUpdatedEvent fromJson(JsonObject jsonObj) {
    AddonUpdatedEvent obj = new AddonUpdatedEvent();
  ...
  public boolean equals(Object o) {
    ...
    AddonUpdatedEvent that = (AddonUpdatedEvent) o;
