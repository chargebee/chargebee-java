...
public class PurchaseCreatedEvent {
  ...
  public static PurchaseCreatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static PurchaseCreatedEvent fromJson(JsonObject jsonObj) {
  ...
  public boolean equals(Object o) {
    ...
    PurchaseCreatedEvent that = (PurchaseCreatedEvent) o;
  ...
  public static class Content {
    ...
    public static Content fromJson(JsonObject jsonObj) {
      ...
      if (__purchaseObj != null) {
        obj.purchase = Purchase.fromJson(__purchaseObj);
      }
