...
public class UsageFileIngestedEvent {
  ...
  public static UsageFileIngestedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static UsageFileIngestedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static UsageFileIngestedEvent fromJson(JsonObject jsonObj) {
    UsageFileIngestedEvent obj = new UsageFileIngestedEvent();
  ...
  public boolean equals(Object o) {
    ...
    UsageFileIngestedEvent that = (UsageFileIngestedEvent) o;
  ...
  public static class Content {
    ...
    public static Content fromJson(JsonObject jsonObj) {
      ...
      if (__usageFileObj != null) {
        obj.usageFile = UsageFile.fromJson(__usageFileObj);
      }
    ...
    @Override
    public String toString() {
      return "Content{" + "usageFile=" + usageFile + "}";
    }
