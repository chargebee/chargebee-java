...
public class QuoteDeletedEvent {
  ...
  public static QuoteDeletedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static QuoteDeletedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static QuoteDeletedEvent fromJson(JsonObject jsonObj) {
    QuoteDeletedEvent obj = new QuoteDeletedEvent();
  ...
  public boolean equals(Object o) {
    ...
    QuoteDeletedEvent that = (QuoteDeletedEvent) o;
  ...
  public static class Content {
    ...
    public static Content fromJson(JsonObject jsonObj) {
      ...
      if (__quoteObj != null) {
        obj.quote = Quote.fromJson(__quoteObj);
      }
    ...
    public int hashCode() {
      ...
      return java.util.Objects.hash(quote);
    }
  }
}
