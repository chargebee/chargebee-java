...
public class ItemPriceDeletedEvent {
  ...
  public static ItemPriceDeletedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static ItemPriceDeletedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static ItemPriceDeletedEvent fromJson(JsonObject jsonObj) {
    ItemPriceDeletedEvent obj = new ItemPriceDeletedEvent();
  ...
  public boolean equals(Object o) {
    ...
    ItemPriceDeletedEvent that = (ItemPriceDeletedEvent) o;
