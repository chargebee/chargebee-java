...
public class VaultTokenCreatedEvent {
  ...
  public static VaultTokenCreatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static VaultTokenCreatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static VaultTokenCreatedEvent fromJson(JsonObject jsonObj) {
    VaultTokenCreatedEvent obj = new VaultTokenCreatedEvent();
  ...
  public boolean equals(Object o) {
    ...
    VaultTokenCreatedEvent that = (VaultTokenCreatedEvent) o;
  ...
  public static class Content {
    ...
    public static Content fromJson(JsonObject jsonObj) {
      ...
      if (__vaultedPaymentMethodObj != null) {
        obj.vaultedPaymentMethod = VaultedPaymentMethod.fromJson(__vaultedPaymentMethodObj);
      }
    ...
    @Override
    public String toString() {
      return "Content{" + "vaultedPaymentMethod=" + vaultedPaymentMethod + "}";
    }
