...
public class PaymentDueReminderEvent {
  ...
  public static PaymentDueReminderEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static PaymentDueReminderEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static PaymentDueReminderEvent fromJson(JsonObject jsonObj) {
    PaymentDueReminderEvent obj = new PaymentDueReminderEvent();
  ...
  public String toString() {
    return "PaymentDueReminderEvent{"
        + "id="
        + id
        + ", occurredAt="
        + occurredAt
  ...
  public boolean equals(Object o) {
    ...
    PaymentDueReminderEvent that = (PaymentDueReminderEvent) o;
  ...
  public static class Content {
    ...
    @Override
    public String toString() {
      return "Content{" + "customer=" + customer + ", invoice=" + invoice + "}";
    }
    ...
    public int hashCode() {
      ...
      return java.util.Objects.hash(customer, invoice);
    }
  }
}
