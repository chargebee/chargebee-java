...
public class OrderResentEvent {
  ...
  public static OrderResentEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static OrderResentEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static OrderResentEvent fromJson(JsonObject jsonObj) {
    OrderResentEvent obj = new OrderResentEvent();
  ...
  public boolean equals(Object o) {
    ...
    OrderResentEvent that = (OrderResentEvent) o;
