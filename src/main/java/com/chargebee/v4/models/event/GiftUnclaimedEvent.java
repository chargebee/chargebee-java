...
public class GiftUnclaimedEvent {
  ...
  public static GiftUnclaimedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static GiftUnclaimedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static GiftUnclaimedEvent fromJson(JsonObject jsonObj) {
    GiftUnclaimedEvent obj = new GiftUnclaimedEvent();
  ...
  public boolean equals(Object o) {
    ...
    GiftUnclaimedEvent that = (GiftUnclaimedEvent) o;
