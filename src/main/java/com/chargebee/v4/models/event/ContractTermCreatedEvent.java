...
public class ContractTermCreatedEvent {
  ...
  public static ContractTermCreatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static ContractTermCreatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static ContractTermCreatedEvent fromJson(JsonObject jsonObj) {
    ContractTermCreatedEvent obj = new ContractTermCreatedEvent();
  ...
  public boolean equals(Object o) {
    ...
    ContractTermCreatedEvent that = (ContractTermCreatedEvent) o;
