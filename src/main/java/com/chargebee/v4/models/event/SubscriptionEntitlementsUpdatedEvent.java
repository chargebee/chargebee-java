...
import com.chargebee.v4.models.subscriptionEntitlementsUpdatedDetail.SubscriptionEntitlementsUpdatedDetail;

public class SubscriptionEntitlementsUpdatedEvent {
  ...
  public static SubscriptionEntitlementsUpdatedEvent fromJson(String json) {
  ...
  public boolean equals(Object o) {
    ...
    SubscriptionEntitlementsUpdatedEvent that = (SubscriptionEntitlementsUpdatedEvent) o;
  ...
  public static class Content {
    ...
    private SubscriptionEntitlementsUpdatedDetail subscriptionEntitlementsUpdatedDetail;

    public SubscriptionEntitlementsUpdatedDetail getSubscriptionEntitlementsUpdatedDetail() {
    ...
    public static Content fromJson(JsonObject jsonObj) {
      ...
      JsonObject __subscriptionEntitlementsUpdatedDetailObj =
          JsonUtil.getJsonObject(jsonObj, "subscription_entitlements_updated_detail");
      if (__subscriptionEntitlementsUpdatedDetailObj != null) {
        obj.subscriptionEntitlementsUpdatedDetail =
            SubscriptionEntitlementsUpdatedDetail.fromJson(
                __subscriptionEntitlementsUpdatedDetailObj);
      }
    ...
    public boolean equals(Object o) {
      ...
      return java.util.Objects.equals(
          subscriptionEntitlementsUpdatedDetail, that.subscriptionEntitlementsUpdatedDetail);
    }

    @Override
    public int hashCode() {

      return java.util.Objects.hash(subscriptionEntitlementsUpdatedDetail);
    }
  }
}
