...
public class SubscriptionEntitlementsUpdatedEvent {
  ...
  public static class Content {
    ...
    public static Content fromJson(String json) {
      ...
      String __subscriptionEntitlementsUpdatedDetailJson =
          JsonUtil.getObject(json, "subscription_entitlements_updated_detail");
      if (__subscriptionEntitlementsUpdatedDetailJson != null) {
        obj.subscriptionEntitlementsUpdatedDetail =
            SubscriptionEntitlementsUpdatedDetail.fromJson(
                __subscriptionEntitlementsUpdatedDetailJson);
      }
