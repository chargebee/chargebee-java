...
public class OrderUpdatedEvent {
  ...
  public static OrderUpdatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static OrderUpdatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static OrderUpdatedEvent fromJson(JsonObject jsonObj) {
    OrderUpdatedEvent obj = new OrderUpdatedEvent();
