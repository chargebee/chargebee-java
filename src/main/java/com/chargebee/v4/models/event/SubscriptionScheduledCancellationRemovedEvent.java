...
public class SubscriptionScheduledCancellationRemovedEvent {
  ...
  public static class Content {
    ...
    public static Content fromJson(String json) {
      ...
      String __advanceInvoiceScheduleJson = JsonUtil.getObject(json, "advance_invoice_schedule");
      if (__advanceInvoiceScheduleJson != null) {
        obj.advanceInvoiceSchedule = AdvanceInvoiceSchedule.fromJson(__advanceInvoiceScheduleJson);
      }
