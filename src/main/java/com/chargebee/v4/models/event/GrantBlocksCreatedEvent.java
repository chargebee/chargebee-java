...
public class GrantBlocksCreatedEvent {
  ...
  public static GrantBlocksCreatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static GrantBlocksCreatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static GrantBlocksCreatedEvent fromJson(JsonObject jsonObj) {
    GrantBlocksCreatedEvent obj = new GrantBlocksCreatedEvent();
  ...
  public String toString() {
    return "GrantBlocksCreatedEvent{"
        + "id="
        + id
        + ", occurredAt="
        + occurredAt
  ...
  public boolean equals(Object o) {
    ...
    GrantBlocksCreatedEvent that = (GrantBlocksCreatedEvent) o;
