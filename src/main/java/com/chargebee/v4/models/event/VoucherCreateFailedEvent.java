...
public class VoucherCreateFailedEvent {
  ...
  public static VoucherCreateFailedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static VoucherCreateFailedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static VoucherCreateFailedEvent fromJson(JsonObject jsonObj) {
    VoucherCreateFailedEvent obj = new VoucherCreateFailedEvent();
  ...
  public boolean equals(Object o) {
    ...
    VoucherCreateFailedEvent that = (VoucherCreateFailedEvent) o;
  ...
  public static class Content {
    ...
    public static Content fromJson(JsonObject jsonObj) {
      ...
      if (__paymentVoucherObj != null) {
        obj.paymentVoucher = PaymentVoucher.fromJson(__paymentVoucherObj);
      }
    ...
    @Override
    public String toString() {
      return "Content{" + "paymentVoucher=" + paymentVoucher + "}";
    }
