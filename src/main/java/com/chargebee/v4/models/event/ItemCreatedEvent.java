...
public class ItemCreatedEvent {
  ...
  public static ItemCreatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static ItemCreatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static ItemCreatedEvent fromJson(JsonObject jsonObj) {
    ItemCreatedEvent obj = new ItemCreatedEvent();
