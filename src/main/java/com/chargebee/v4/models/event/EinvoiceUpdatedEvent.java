...
public class EinvoiceUpdatedEvent {
  ...
  public static EinvoiceUpdatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static EinvoiceUpdatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static EinvoiceUpdatedEvent fromJson(JsonObject jsonObj) {
    EinvoiceUpdatedEvent obj = new EinvoiceUpdatedEvent();
  ...
  public boolean equals(Object o) {
    ...
    EinvoiceUpdatedEvent that = (EinvoiceUpdatedEvent) o;
  ...
  public static class Content {
    ...
    @Override
    public String toString() {
      return "Content{" + "einvoice=" + einvoice + "}";
    }
