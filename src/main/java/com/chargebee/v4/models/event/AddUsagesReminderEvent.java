...
import com.chargebee.v4.models.usageReminderInfo.UsageReminderInfo;
...
public class AddUsagesReminderEvent {
  ...
  public static class Content {
    ...
    public static Content fromJson(JsonObject jsonObj) {
      ...
      JsonObject __usageReminderInfoObj = JsonUtil.getJsonObject(jsonObj, "usage_reminder_info");
      if (__usageReminderInfoObj != null) {
        obj.usageReminderInfo = UsageReminderInfo.fromJson(__usageReminderInfoObj);
      }
