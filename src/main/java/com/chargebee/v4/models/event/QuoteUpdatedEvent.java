...
public class QuoteUpdatedEvent {
  ...
  public static QuoteUpdatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static QuoteUpdatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static QuoteUpdatedEvent fromJson(JsonObject jsonObj) {
    QuoteUpdatedEvent obj = new QuoteUpdatedEvent();
  ...
  public boolean equals(Object o) {
    ...
    QuoteUpdatedEvent that = (QuoteUpdatedEvent) o;
