...
import com.chargebee.v4.models.token.Token;

public class TokenConsumedEvent {
  ...
  public static TokenConsumedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static TokenConsumedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static TokenConsumedEvent fromJson(JsonObject jsonObj) {
    TokenConsumedEvent obj = new TokenConsumedEvent();
  ...
  public boolean equals(Object o) {
    ...
    TokenConsumedEvent that = (TokenConsumedEvent) o;
  ...
  public static class Content {
    ...
    public static Content fromJson(JsonObject jsonObj) {
      ...
      JsonObject __tokenObj = JsonUtil.getJsonObject(jsonObj, "token");
      if (__tokenObj != null) {
        obj.token = Token.fromJson(__tokenObj);
      }
