...
public class CardUpdatedEvent {
  ...
  public static CardUpdatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static CardUpdatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static CardUpdatedEvent fromJson(JsonObject jsonObj) {
    CardUpdatedEvent obj = new CardUpdatedEvent();
  ...
  public boolean equals(Object o) {
    ...
    CardUpdatedEvent that = (CardUpdatedEvent) o;
