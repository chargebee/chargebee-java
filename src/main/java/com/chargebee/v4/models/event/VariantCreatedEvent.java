...
public class VariantCreatedEvent {
  ...
  public static VariantCreatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static VariantCreatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static VariantCreatedEvent fromJson(JsonObject jsonObj) {
    VariantCreatedEvent obj = new VariantCreatedEvent();
  ...
  public boolean equals(Object o) {
    ...
    VariantCreatedEvent that = (VariantCreatedEvent) o;
