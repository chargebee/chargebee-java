...
public class PaymentSchedulesUpdatedEvent {
  ...
  public static PaymentSchedulesUpdatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static PaymentSchedulesUpdatedEvent fromJson(JsonObject jsonObj) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentSchedulesUpdatedEvent that = (PaymentSchedulesUpdatedEvent) o;
  ...
  public static class Content {
    ...
    public static Content fromJson(JsonObject jsonObj) {
      ...
      if (__paymentScheduleObj != null) {
        obj.paymentSchedule = PaymentSchedule.fromJson(__paymentScheduleObj);
      }
    ...
    @Override
    public String toString() {
      return "Content{" + "paymentSchedule=" + paymentSchedule + "}";
    }
