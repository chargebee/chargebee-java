...
public class PaymentScheduleSchemeCreatedEvent {
  ...
  public static PaymentScheduleSchemeCreatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static PaymentScheduleSchemeCreatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static PaymentScheduleSchemeCreatedEvent fromJson(JsonObject jsonObj) {
    PaymentScheduleSchemeCreatedEvent obj = new PaymentScheduleSchemeCreatedEvent();
  ...
  public boolean equals(Object o) {
    ...
    PaymentScheduleSchemeCreatedEvent that = (PaymentScheduleSchemeCreatedEvent) o;
  ...
  public static class Content {
    ...
    public static Content fromJson(JsonObject jsonObj) {
      ...
      if (__paymentScheduleSchemeObj != null) {
        obj.paymentScheduleScheme = PaymentScheduleScheme.fromJson(__paymentScheduleSchemeObj);
      }

      obj.flexibleSchedules = JsonUtil.getObject(jsonObj, "flexible_schedules");
    ...
    public boolean equals(Object o) {
      ...
      return java.util.Objects.equals(paymentScheduleScheme, that.paymentScheduleScheme)
          && java.util.Objects.equals(flexibleSchedules, that.flexibleSchedules);
    }

    @Override
    public int hashCode() {

      return java.util.Objects.hash(paymentScheduleScheme, flexibleSchedules);
    }
  }
}
