...
public class CreditNoteUpdatedEvent {
  ...
  public static CreditNoteUpdatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static CreditNoteUpdatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static CreditNoteUpdatedEvent fromJson(JsonObject jsonObj) {
    CreditNoteUpdatedEvent obj = new CreditNoteUpdatedEvent();
  ...
  public boolean equals(Object o) {
    ...
    CreditNoteUpdatedEvent that = (CreditNoteUpdatedEvent) o;
