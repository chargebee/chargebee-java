  ...
  public static class Content {
    ...
    public static Content fromJson(String json) {
      ...
      if (__priceVariantJson != null) {
        obj.priceVariant = PriceVariant.fromJson(__priceVariantJson);
      }

      String __attributeJson = JsonUtil.getObject(json, "attribute");
      if (__attributeJson != null) {
        obj.attribute = Attribute.fromJson(__attributeJson);
      }
