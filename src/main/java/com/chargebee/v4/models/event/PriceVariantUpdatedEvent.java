...
import com.chargebee.v4.models.attribute.Attribute;

public class PriceVariantUpdatedEvent {
  ...
  public static PriceVariantUpdatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static PriceVariantUpdatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static PriceVariantUpdatedEvent fromJson(JsonObject jsonObj) {
    PriceVariantUpdatedEvent obj = new PriceVariantUpdatedEvent();
  ...
  public boolean equals(Object o) {
    ...
    PriceVariantUpdatedEvent that = (PriceVariantUpdatedEvent) o;
  ...
  public static class Content {
    ...
    public static Content fromJson(JsonObject jsonObj) {
      ...
      if (__priceVariantObj != null) {
        obj.priceVariant = PriceVariant.fromJson(__priceVariantObj);
      }

      JsonObject __attributeObj = JsonUtil.getJsonObject(jsonObj, "attribute");
      if (__attributeObj != null) {
        obj.attribute = Attribute.fromJson(__attributeObj);
      }
    ...
    @Override
    public String toString() {
      return "Content{" + "priceVariant=" + priceVariant + ", attribute=" + attribute + "}";
    }
    ...
    public int hashCode() {
      ...
      return java.util.Objects.hash(priceVariant, attribute);
    }
  }
}
