...
public class TransactionDeletedEvent {
  ...
  public static TransactionDeletedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static TransactionDeletedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static TransactionDeletedEvent fromJson(JsonObject jsonObj) {
    TransactionDeletedEvent obj = new TransactionDeletedEvent();
  ...
  public boolean equals(Object o) {
    ...
    TransactionDeletedEvent that = (TransactionDeletedEvent) o;
