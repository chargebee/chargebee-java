...
public class FeatureArchivedEvent {
  ...
  public static FeatureArchivedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static FeatureArchivedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static FeatureArchivedEvent fromJson(JsonObject jsonObj) {
    FeatureArchivedEvent obj = new FeatureArchivedEvent();
  ...
  public boolean equals(Object o) {
    ...
    FeatureArchivedEvent that = (FeatureArchivedEvent) o;
  ...
  public static class Content {
    ...
    @Override
    public String toString() {
      return "Content{" + "feature=" + feature + ", metadata=" + metadata + "}";
    }
    ...
    public int hashCode() {
      ...
      return java.util.Objects.hash(feature, metadata);
    }
  }
}
