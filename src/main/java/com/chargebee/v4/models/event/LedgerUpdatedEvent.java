...
public class LedgerUpdatedEvent {
  ...
  public static LedgerUpdatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static LedgerUpdatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static LedgerUpdatedEvent fromJson(JsonObject jsonObj) {
    LedgerUpdatedEvent obj = new LedgerUpdatedEvent();
  ...
  public boolean equals(Object o) {
    ...
    LedgerUpdatedEvent that = (LedgerUpdatedEvent) o;
  ...
  public static class Content {
    ...
    public int hashCode() {
      ...
      return java.util.Objects.hash(
          ledgerOperations, ledgerAccountBalance, grantBlocks, ledgerEntries);
    }
  }
}
