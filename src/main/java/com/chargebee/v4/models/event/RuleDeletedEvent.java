...
public class RuleDeletedEvent {
  ...
  public static RuleDeletedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static RuleDeletedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static RuleDeletedEvent fromJson(JsonObject jsonObj) {
    RuleDeletedEvent obj = new RuleDeletedEvent();
  ...
  public boolean equals(Object o) {
    ...
    RuleDeletedEvent that = (RuleDeletedEvent) o;
