...
public class CustomerCreatedEvent {
  ...
  public static CustomerCreatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static CustomerCreatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static CustomerCreatedEvent fromJson(JsonObject jsonObj) {
    CustomerCreatedEvent obj = new CustomerCreatedEvent();
