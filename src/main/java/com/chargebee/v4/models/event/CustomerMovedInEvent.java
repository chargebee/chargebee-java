...
public class CustomerMovedInEvent {
  ...
  public static CustomerMovedInEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static CustomerMovedInEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static CustomerMovedInEvent fromJson(JsonObject jsonObj) {
    CustomerMovedInEvent obj = new CustomerMovedInEvent();
  ...
  public boolean equals(Object o) {
    ...
    CustomerMovedInEvent that = (CustomerMovedInEvent) o;
