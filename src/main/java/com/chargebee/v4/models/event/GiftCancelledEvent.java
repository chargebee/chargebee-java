...
public class GiftCancelledEvent {
  ...
  public static GiftCancelledEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static GiftCancelledEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static GiftCancelledEvent fromJson(JsonObject jsonObj) {
    GiftCancelledEvent obj = new GiftCancelledEvent();
  ...
  public boolean equals(Object o) {
    ...
    GiftCancelledEvent that = (GiftCancelledEvent) o;
  ...
  public static class Content {
    ...
    public static Content fromJson(JsonObject jsonObj) {
      ...
      if (__giftObj != null) {
        obj.gift = Gift.fromJson(__giftObj);
      }
    ...
    public int hashCode() {
      ...
      return java.util.Objects.hash(gift);
    }
  }
}
