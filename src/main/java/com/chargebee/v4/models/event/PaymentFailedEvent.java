...
public class PaymentFailedEvent {
  ...
  public static PaymentFailedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static PaymentFailedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static PaymentFailedEvent fromJson(JsonObject jsonObj) {
    PaymentFailedEvent obj = new PaymentFailedEvent();
