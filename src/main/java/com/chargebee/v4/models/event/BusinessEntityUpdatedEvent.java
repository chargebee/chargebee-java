...
import com.chargebee.v4.models.businessEntity.BusinessEntity;

public class BusinessEntityUpdatedEvent {
  ...
  public static BusinessEntityUpdatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static BusinessEntityUpdatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static BusinessEntityUpdatedEvent fromJson(JsonObject jsonObj) {
    BusinessEntityUpdatedEvent obj = new BusinessEntityUpdatedEvent();
  ...
  public boolean equals(Object o) {
    ...
    BusinessEntityUpdatedEvent that = (BusinessEntityUpdatedEvent) o;
  ...
  public static class Content {
    ...
    public static Content fromJson(JsonObject jsonObj) {
      ...
      JsonObject __businessEntityObj = JsonUtil.getJsonObject(jsonObj, "business_entity");
      if (__businessEntityObj != null) {
        obj.businessEntity = BusinessEntity.fromJson(__businessEntityObj);
      }
    ...
    @Override
    public String toString() {
      return "Content{" + "businessEntity=" + businessEntity + "}";
    }
    ...
    public boolean equals(Object o) {
      ...
      return java.util.Objects.equals(businessEntity, that.businessEntity);
    }

    @Override
    public int hashCode() {

      return java.util.Objects.hash(businessEntity);
    }
  }
}
