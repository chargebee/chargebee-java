...
public class BusinessEntityUpdatedEvent {
  ...
  public static class Content {
    ...
    public static Content fromJson(String json) {
      ...
      String __businessEntityJson = JsonUtil.getObject(json, "business_entity");
      if (__businessEntityJson != null) {
        obj.businessEntity = BusinessEntity.fromJson(__businessEntityJson);
      }
