...
import com.chargebee.v4.models.impactedCustomer.ImpactedCustomer;

public class CustomerEntitlementsUpdatedEvent {
  ...
  public static CustomerEntitlementsUpdatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static CustomerEntitlementsUpdatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static CustomerEntitlementsUpdatedEvent fromJson(JsonObject jsonObj) {
    CustomerEntitlementsUpdatedEvent obj = new CustomerEntitlementsUpdatedEvent();
  ...
  public boolean equals(Object o) {
    ...
    CustomerEntitlementsUpdatedEvent that = (CustomerEntitlementsUpdatedEvent) o;
  ...
  public static class Content {
    ...
    private ImpactedCustomer impactedCustomer;

    public ImpactedCustomer getImpactedCustomer() {
    ...
    public static Content fromJson(JsonObject jsonObj) {
      ...
      JsonObject __impactedCustomerObj = JsonUtil.getJsonObject(jsonObj, "impacted_customer");
      if (__impactedCustomerObj != null) {
        obj.impactedCustomer = ImpactedCustomer.fromJson(__impactedCustomerObj);
      }
    ...
    @Override
    public String toString() {
      return "Content{" + "impactedCustomer=" + impactedCustomer + "}";
    }
    ...
    public boolean equals(Object o) {
      ...
      return java.util.Objects.equals(impactedCustomer, that.impactedCustomer);
    }

    @Override
    public int hashCode() {

      return java.util.Objects.hash(impactedCustomer);
    }
  }
}
