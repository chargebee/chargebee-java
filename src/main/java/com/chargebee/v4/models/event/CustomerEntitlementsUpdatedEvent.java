...
public class CustomerEntitlementsUpdatedEvent {
  ...
  public static class Content {
    ...
    public static Content fromJson(String json) {
      ...
      String __impactedCustomerJson = JsonUtil.getObject(json, "impacted_customer");
      if (__impactedCustomerJson != null) {
        obj.impactedCustomer = ImpactedCustomer.fromJson(__impactedCustomerJson);
      }
