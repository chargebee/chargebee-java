...
public class GrantBlocksUpdatedEvent {
  ...
  public static GrantBlocksUpdatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static GrantBlocksUpdatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static GrantBlocksUpdatedEvent fromJson(JsonObject jsonObj) {
    GrantBlocksUpdatedEvent obj = new GrantBlocksUpdatedEvent();
  ...
  public String toString() {
    return "GrantBlocksUpdatedEvent{"
        + "id="
        + id
        + ", occurredAt="
        + occurredAt
  ...
  public boolean equals(Object o) {
    ...
    GrantBlocksUpdatedEvent that = (GrantBlocksUpdatedEvent) o;
  ...
  public static class Content {
    ...
    @Override
    public String toString() {
      return "Content{" + "grantBlocks=" + grantBlocks + "}";
    }
    ...
    public boolean equals(Object o) {
      ...
      return java.util.Objects.equals(grantBlocks, that.grantBlocks);
    }

    @Override
    public int hashCode() {

      return java.util.Objects.hash(grantBlocks);
    }
  }
}
