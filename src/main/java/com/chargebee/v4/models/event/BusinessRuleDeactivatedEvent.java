...
public class BusinessRuleDeactivatedEvent {
  ...
  public static BusinessRuleDeactivatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static BusinessRuleDeactivatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static BusinessRuleDeactivatedEvent fromJson(JsonObject jsonObj) {
    BusinessRuleDeactivatedEvent obj = new BusinessRuleDeactivatedEvent();
  ...
  public String toString() {
    return "BusinessRuleDeactivatedEvent{"
        + "id="
        + id
        + ", occurredAt="
        + occurredAt
  ...
  public boolean equals(Object o) {
    ...
    BusinessRuleDeactivatedEvent that = (BusinessRuleDeactivatedEvent) o;
  ...
  public static class Content {
    ...
    public static Content fromJson(JsonObject jsonObj) {
      ...
      if (__businessRuleObj != null) {
        obj.businessRule = BusinessRule.fromJson(__businessRuleObj);
      }
    ...
    @Override
    public String toString() {
      return "Content{" + "businessRule=" + businessRule + "}";
    }
