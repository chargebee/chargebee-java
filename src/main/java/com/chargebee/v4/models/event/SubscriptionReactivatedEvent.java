...
public class SubscriptionReactivatedEvent {
  ...
  public static SubscriptionReactivatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static SubscriptionReactivatedEvent fromJson(JsonObject jsonObj) {
