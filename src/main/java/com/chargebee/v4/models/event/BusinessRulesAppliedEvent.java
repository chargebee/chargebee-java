...
import com.chargebee.v4.models.appliedBusinessRule.AppliedBusinessRule;
...
public class BusinessRulesAppliedEvent {
  ...
  public static BusinessRulesAppliedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static BusinessRulesAppliedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static BusinessRulesAppliedEvent fromJson(JsonObject jsonObj) {
    BusinessRulesAppliedEvent obj = new BusinessRulesAppliedEvent();
  ...
  public String toString() {
    return "BusinessRulesAppliedEvent{"
        + "id="
        + id
        + ", occurredAt="
        + occurredAt
  ...
  public boolean equals(Object o) {
    ...
    BusinessRulesAppliedEvent that = (BusinessRulesAppliedEvent) o;
  ...
  public static class Content {
    ...
    private AppliedBusinessRule businessRulesApplied;

    public AppliedBusinessRule getBusinessRulesApplied() {
    ...
    public static Content fromJson(JsonObject jsonObj) {
      ...
      JsonObject __businessRulesAppliedObj =
          JsonUtil.getJsonObject(jsonObj, "business_rules_applied");
      if (__businessRulesAppliedObj != null) {
        obj.businessRulesApplied = AppliedBusinessRule.fromJson(__businessRulesAppliedObj);
      }
    ...
    @Override
    public String toString() {
      return "Content{" + "businessRulesApplied=" + businessRulesApplied + "}";
    }
    ...
    public boolean equals(Object o) {
      ...
      return java.util.Objects.equals(businessRulesApplied, that.businessRulesApplied);
    }

    @Override
    public int hashCode() {

      return java.util.Objects.hash(businessRulesApplied);
    }
  }
}
