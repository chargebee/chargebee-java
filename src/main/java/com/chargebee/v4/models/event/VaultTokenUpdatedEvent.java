...
public class VaultTokenUpdatedEvent {
  ...
  public static VaultTokenUpdatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static VaultTokenUpdatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static VaultTokenUpdatedEvent fromJson(JsonObject jsonObj) {
    VaultTokenUpdatedEvent obj = new VaultTokenUpdatedEvent();
  ...
  public boolean equals(Object o) {
    ...
    VaultTokenUpdatedEvent that = (VaultTokenUpdatedEvent) o;
