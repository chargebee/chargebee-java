...
public class BusinessRuleActivatedEvent {
  ...
  public static BusinessRuleActivatedEvent fromJson(String json) {
    return fromJson(JsonUtil.parse(json));
  }

  public static BusinessRuleActivatedEvent fromJson(java.util.Map<String, Object> map) {
    return fromJson(JsonUtil.toJson(map));
  }

  public static BusinessRuleActivatedEvent fromJson(JsonObject jsonObj) {
    BusinessRuleActivatedEvent obj = new BusinessRuleActivatedEvent();
  ...
  public String toString() {
    return "BusinessRuleActivatedEvent{"
        + "id="
        + id
        + ", occurredAt="
        + occurredAt
  ...
  public boolean equals(Object o) {
    ...
    BusinessRuleActivatedEvent that = (BusinessRuleActivatedEvent) o;
