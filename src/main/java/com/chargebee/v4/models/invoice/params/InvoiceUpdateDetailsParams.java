...
public final class InvoiceUpdateDetailsParams {
  ...
  public static final class InvoiceUpdateDetailsBuilder {
     ...
     */
    public InvoiceUpdateDetailsBuilder customField(String fieldName, String value) {
     ...
     */
    public InvoiceUpdateDetailsBuilder customFields(Map<String, String> customFields) {
