...
public final class InvoiceListResponse {
  ...
  public static InvoiceListResponse fromJson(String json) {
    try {
      ...
      List<InvoiceListItem> list =
          JsonUtil.mapArray(JsonUtil.getJsonArray(jsonObj, "list"), InvoiceListItem::fromJson);
   ...
   */
  public InvoiceListResponse nextPage() throws ChargebeeException {
    if (!hasNextPage()) {
  ...
  public String toString() {
    return "InvoiceListResponse{" + "list=" + list + ", nextOffset=" + nextOffset + "}";
  }
  ...
  public boolean equals(Object o) {
    ...
    InvoiceListResponse that = (InvoiceListResponse) o;
  ...
  public static class InvoiceListItem {
    ...
    public static InvoiceListItem fromJson(JsonObject jsonObj) {
