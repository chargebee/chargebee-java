...
public final class PdfForInvoiceParams {

  private final DispositionType dispositionType;

  private PdfForInvoiceParams(PdfForInvoiceBuilder builder) {
  ...
  /** Create a new builder for PdfForInvoiceParams. */
  @Recommended(reason = "Preferred for reusability, validation, and LLM-friendliness")
  public static PdfForInvoiceBuilder builder() {
    return new PdfForInvoiceBuilder();
  }

  public static final class PdfForInvoiceBuilder {

    private DispositionType dispositionType;

    private PdfForInvoiceBuilder() {}

    public PdfForInvoiceBuilder dispositionType(DispositionType value) {
      this.dispositionType = value;
      return this;
    }

    public PdfForInvoiceParams build() {
      return new PdfForInvoiceParams(this);
    }
  }
