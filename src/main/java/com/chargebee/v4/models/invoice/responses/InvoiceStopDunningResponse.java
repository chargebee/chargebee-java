 ...
 * API.
 */
public final class InvoiceStopDunningResponse extends BaseResponse {
  ...
  /** Parse JSON response into InvoiceStopDunningResponse object with HTTP response. */
  public static InvoiceStopDunningResponse fromJson(String json, Response httpResponse) {
    try {
