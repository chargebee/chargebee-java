...
public final class PersonalizedOfferCreateParams {
  ...
  private PersonalizedOfferCreateParams(PersonalizedOfferCreateBuilder builder) {
  ...
  /** Create a new builder for PersonalizedOfferCreateParams. */
  @Recommended(reason = "Preferred for reusability, validation, and LLM-friendliness")
  public static PersonalizedOfferCreateBuilder builder() {
    return new PersonalizedOfferCreateBuilder();
  }

  public static final class PersonalizedOfferCreateBuilder {
    ...
    private PersonalizedOfferCreateBuilder() {}

    public PersonalizedOfferCreateBuilder firstName(String value) {
      this.firstName = value;
      return this;
    }

    public PersonalizedOfferCreateBuilder lastName(String value) {
      this.lastName = value;
      return this;
    }

    public PersonalizedOfferCreateBuilder email(String value) {
      this.email = value;
      return this;
    }

    public PersonalizedOfferCreateBuilder roles(List<String> value) {
      this.roles = value;
      return this;
    }

    public PersonalizedOfferCreateBuilder externalUserId(String value) {
      this.externalUserId = value;
      return this;
    }

    public PersonalizedOfferCreateBuilder subscriptionId(String value) {
      this.subscriptionId = value;
      return this;
    }

    public PersonalizedOfferCreateBuilder customerId(String value) {
      this.customerId = value;
      return this;
    }

    public PersonalizedOfferCreateBuilder custom(java.util.Map<String, Object> value) {
      this.custom = value;
      return this;
    }

    public PersonalizedOfferCreateBuilder requestContext(RequestContextParams value) {
      this.requestContext = value;
      return this;
    }

    public PersonalizedOfferCreateParams build() {
      return new PersonalizedOfferCreateParams(this);
    }
  }
