...
public final class DifferentialPriceRetrieveResponse extends BaseResponse {
  ...
  public String toString() {
    return "DifferentialPriceRetrieveResponse{" + "differentialPrice=" + differentialPrice + "}";
  }
  ...
  public boolean equals(Object o) {
    ...
    DifferentialPriceRetrieveResponse that = (DifferentialPriceRetrieveResponse) o;
