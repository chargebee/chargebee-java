...
final class ServiceRegistry {
  ...
  private volatile EmailLogService emailLogService;
  ...
  private volatile DisputeService disputeService;
  ...
  private volatile EinvoiceService einvoiceService;
  ...
  private volatile BusinessRuleService businessRuleService;
  ...
  private volatile PaymentScheduleService paymentScheduleService;
  ...
  private volatile BusinessRulesetService businessRulesetService;
  ...
  /**
   * Get or create the EmailLogService instance. Thread-safe lazy initialization using
   * double-checked locking.
   */
  EmailLogService emailLogs() {
    if (emailLogService == null) {
      synchronized (this) {
        if (emailLogService == null) {
          emailLogService = new EmailLogService(client);
        }
      }
    }
  ...
  /**
   * Get or create the DisputeService instance. Thread-safe lazy initialization using double-checked
   * locking.
   */
  DisputeService disputes() {
    if (disputeService == null) {
      synchronized (this) {
        if (disputeService == null) {
          disputeService = new DisputeService(client);
        }
      }
    }
  ...
  /**
   * Get or create the EinvoiceService instance. Thread-safe lazy initialization using
   * double-checked locking.
   */
  EinvoiceService einvoices() {
    if (einvoiceService == null) {
      synchronized (this) {
        if (einvoiceService == null) {
          einvoiceService = new EinvoiceService(client);
        }
      }
    }
  ...
  /**
   * Get or create the BusinessRuleService instance. Thread-safe lazy initialization using
   * double-checked locking.
   */
  BusinessRuleService businessRules() {
    if (businessRuleService == null) {
      synchronized (this) {
        if (businessRuleService == null) {
          businessRuleService = new BusinessRuleService(client);
        }
      }
    }
  ...
  /**
   * Get or create the PaymentScheduleService instance. Thread-safe lazy initialization using
   * double-checked locking.
   */
  PaymentScheduleService paymentSchedules() {
    if (paymentScheduleService == null) {
      synchronized (this) {
        if (paymentScheduleService == null) {
          paymentScheduleService = new PaymentScheduleService(client);
        }
      }
    }
  ...
  /**
   * Get or create the BusinessRulesetService instance. Thread-safe lazy initialization using
   * double-checked locking.
   */
  BusinessRulesetService businessRulesets() {
    if (businessRulesetService == null) {
      synchronized (this) {
        if (businessRulesetService == null) {
          businessRulesetService = new BusinessRulesetService(client);
        }
      }
    }
    return businessRulesetService;
  }
