...
import com.chargebee.core.models.usage.params.UsageListParams;

/**
 * Immutable response object for UsageList operation. Contains paginated list data with
 * auto-pagination support.
 */
public final class UsageListResponse implements Iterable<UsageListResponse.UsageListItem> {
   ...
   */
  public UsageListResponse autoPaginate() {
    return new UsageListResponse(list, nextOffset, service, originalParams, true);
  }

  /** Iterator implementation for auto-pagination support. */
  @Override
  public Iterator<UsageListItem> iterator() {
    if (isAutoPaginate) {
  ...
  private class AutoPaginateIterator implements Iterator<UsageListItem> {
    private UsageListResponse currentPage = UsageListResponse.this;
    private Iterator<UsageListItem> currentIterator = currentPage.list.iterator();
