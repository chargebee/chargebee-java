...
/**
 * Immutable response object for EventList operation. Contains paginated list data with
 * auto-pagination support.
 */
public final class EventListResponse implements Iterable<EventListResponse.EventListItem> {
   ...
   */
  public EventListResponse autoPaginate() {
    return new EventListResponse(list, nextOffset, service, originalParams, true);
  }

  /** Iterator implementation for auto-pagination support. */
  @Override
  public Iterator<EventListItem> iterator() {
    if (isAutoPaginate) {
  ...
  private class AutoPaginateIterator implements Iterator<EventListItem> {
    private EventListResponse currentPage = EventListResponse.this;
    private Iterator<EventListItem> currentIterator = currentPage.list.iterator();
