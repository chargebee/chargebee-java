...
public final class ItemPriceFindApplicableItemsResponse
    implements Iterable<ItemPriceFindApplicableItemsResponse.ItemPriceFindApplicableItemsItem> {
   ...
   */
  public ItemPriceFindApplicableItemsResponse autoPaginate() {
    return new ItemPriceFindApplicableItemsResponse(
  ...
  @Override
  public Iterator<ItemPriceFindApplicableItemsItem> iterator() {
    if (isAutoPaginate) {
  ...
  private class AutoPaginateIterator implements Iterator<ItemPriceFindApplicableItemsItem> {
    private ItemPriceFindApplicableItemsResponse currentPage =
        ItemPriceFindApplicableItemsResponse.this;
    private Iterator<ItemPriceFindApplicableItemsItem> currentIterator =
    ...
    @Override
    public ItemPriceFindApplicableItemsItem next() {
      if (!hasNext()) {
