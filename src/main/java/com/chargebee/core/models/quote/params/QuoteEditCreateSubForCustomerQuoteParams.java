...
public final class QuoteEditCreateSubForCustomerQuoteParams {
  ...
  private QuoteEditCreateSubForCustomerQuoteParams(
      QuoteEditCreateSubForCustomerQuoteBuilder builder) {
  ...
  /** Create a new builder for QuoteEditCreateSubForCustomerQuoteParams. */
  @Recommended(reason = "Preferred for reusability, validation, and LLM-friendliness")
  public static QuoteEditCreateSubForCustomerQuoteBuilder builder() {
    return new QuoteEditCreateSubForCustomerQuoteBuilder();
  }

  public static final class QuoteEditCreateSubForCustomerQuoteBuilder {
    ...
    public QuoteEditCreateSubForCustomerQuoteBuilder subscription(SubscriptionParams value) {
      formData.put("subscription", value);
      return this;
    }

    public QuoteEditCreateSubForCustomerQuoteBuilder shippingAddress(ShippingAddressParams value) {
      formData.put("shipping_address", value);
      return this;
    }

    public QuoteEditCreateSubForCustomerQuoteBuilder contractTerm(ContractTermParams value) {
    ...
    public QuoteEditCreateSubForCustomerQuoteParams build() {
      return new QuoteEditCreateSubForCustomerQuoteParams(this);
    }
