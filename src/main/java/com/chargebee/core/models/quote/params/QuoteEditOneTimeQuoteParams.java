...
public final class QuoteEditOneTimeQuoteParams {

  private final Map<String, Object> formData;

  private QuoteEditOneTimeQuoteParams(QuoteEditOneTimeQuoteBuilder builder) {
  ...
  /** Create a new builder for QuoteEditOneTimeQuoteParams. */
  @Recommended(reason = "Preferred for reusability, validation, and LLM-friendliness")
  public static QuoteEditOneTimeQuoteBuilder builder() {
    return new QuoteEditOneTimeQuoteBuilder();
  }

  public static final class QuoteEditOneTimeQuoteBuilder {
    ...
    public QuoteEditOneTimeQuoteParams build() {
      return new QuoteEditOneTimeQuoteParams(this);
    }
  }
